...
public class OpenSagaProcessData:PostgresuSMS{

public OpenSagaProcessData(){
...
var Resultado = Conexion.exec_params ("""SELECT opensaga.fun_eventtype_default($1::integer, $2::text);""",  valuessms.length, null, valuessms, null, null, 0);
...
GLib.print("\n[OpenSAGA]: Receptor procesando ");

var  Conexion = Postgres.connect_db (this.ConnString());

if(Conexion.get_status () == ConnectionStatus.OK){
//GLib.print("Conectado\n");
var Resultado = Conexion.exec("""SELECT * FROM opensaga.hearbeat();""");
...
GLib.print("\n[OpenSAGA]: Procesando llamadas entrantes\n");
...
if(Conexion.get_status () == ConnectionStatus.OK){
//GLib.print("Conectado\n");
var Resultado = Conexion.exec("""SELECT * FROM opensaga.fun_receiver_from_incomingcalls();""");
...
GLib.print("\n[OpenSAGA]: Procesando SMSs entrantes\n");
// Lee las llamadas recibidas desde la tabla incomingcall, verifica si pertenece a algun usuario del sistema de alarma e ingresa el evento
//int Retorno = -1;
var  Conexion = Postgres.connect_db (this.ConnString());
...
if(Conexion.get_status () == ConnectionStatus.OK){
//GLib.print("Conectado\n");
var Resultado = Conexion.exec("""SELECT * FROM opensaga.fun_receiver_from_incomingsmss();""");
...
GLib.print("\n[OpenSAGA]: Generando reportes de prueba automaticos\n");
var  Conexion = Postgres.connect_db (this.ConnString());

if(Conexion.get_status () == ConnectionStatus.OK){
//GLib.print("Conectado\n");
var Resultado = Conexion.exec("""SELECT * FROM opensaga.fun_generate_test_report();""");
