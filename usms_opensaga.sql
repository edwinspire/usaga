...
-- Started on 2013-01-08 15:40:02 ECT
...
--
-- TOC entry 2609 (class 1262 OID 16384)
-- Dependencies: 2608
...
--
-- TOC entry 232 (class 3079 OID 11644)
...
--
-- TOC entry 301 (class 1255 OID 26932)
-- Dependencies: 7 808
...
--
-- TOC entry 305 (class 1255 OID 26948)
-- Dependencies: 808 7
...
--
-- TOC entry 291 (class 1255 OID 26854)
-- Dependencies: 7 808
...
--
-- TOC entry 302 (class 1255 OID 26944)
-- Dependencies: 808 7
...
--
-- TOC entry 296 (class 1255 OID 26420)
-- Dependencies: 808 7
...
--
-- TOC entry 275 (class 1255 OID 26378)
-- Dependencies: 808 7
...
--
-- TOC entry 293 (class 1255 OID 26867)
-- Dependencies: 7 808
...
--
-- TOC entry 298 (class 1255 OID 26920)
-- Dependencies: 7 808
...
--
-- TOC entry 258 (class 1255 OID 26915)
-- Dependencies: 7 808
...
--
-- TOC entry 299 (class 1255 OID 26931)
-- Dependencies: 808 7
...
--
-- TOC entry 265 (class 1255 OID 17943)
-- Dependencies: 808 7
...
--
-- TOC entry 295 (class 1255 OID 26913)
-- Dependencies: 7 808
...
--
-- TOC entry 284 (class 1255 OID 26355)
-- Dependencies: 808 7
...
--
-- TOC entry 285 (class 1255 OID 26374)
-- Dependencies: 808 7
...
--
-- TOC entry 287 (class 1255 OID 26413)
-- Dependencies: 808 7
...
--
-- TOC entry 286 (class 1255 OID 26410)
-- Dependencies: 7 808
...
--
-- TOC entry 297 (class 1255 OID 26919)
-- Dependencies: 808 7
...
--
-- TOC entry 257 (class 1255 OID 26914)
-- Dependencies: 7 808
...
--
-- TOC entry 307 (class 1255 OID 26962)
-- Dependencies: 5 808
...
--
-- TOC entry 248 (class 1255 OID 26967)
-- Dependencies: 5 808
...
--
-- TOC entry 310 (class 1255 OID 26966)
-- Dependencies: 5 808
...
--
-- TOC entry 300 (class 1255 OID 26934)
-- Dependencies: 5 808
-- Name: fun_phones_table(integer, integer, boolean, text, integer, integer, real, real, text, text, text, integer, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_phones_table(inidphone integer, inidcontact integer, inenable boolean, inphone text, intypephone integer, inidprovider integer, ingeox real, ingeoy real, inphone_ext text, inidaddress text, inaddress text, inubiphone integer, innote text, OUT outreturn integer, OUT outpgmsg text) RETURNS record
    LANGUAGE plpgsql
    AS $$DECLARE
...
-- Dependencies: 300
-- Name: FUNCTION fun_phones_table(inidphone integer, inidcontact integer, inenable boolean, inphone text, intypephone integer, inidprovider integer, ingeox real, ingeoy real, inphone_ext text, inidaddress text, inaddress text, inubiphone integer, innote text, OUT outreturn integer, OUT outpgmsg text); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION fun_phones_table(inidphone integer, inidcontact integer, inenable boolean, inphone text, intypephone integer, inidprovider integer, ingeox real, ingeoy real, inphone_ext text, inidaddress text, inaddress text, inubiphone integer, innote text, OUT outreturn integer, OUT outpgmsg text) IS 'Funcion edita, crea y elimina registros de la tabla phones';


--
-- TOC entry 252 (class 1255 OID 26978)
-- Dependencies: 808 5
...
OPEN CursorResultado FOR SELECT * FROM fun_phones_table(inidcontact, inenable, intitle, infirstname, inlastname, ingender, inbirthday, intypeofid, inidentification, inweb, inemail1, inemail2, inidaddress, innote, fieldtextasbase64);
SELECT * FROM cursor_to_xml(CursorResultado, 10, false, false, '') INTO Retorno;
CLOSE CursorResultado;
RETURN '<table>'||Retorno||'</table>';
...
--
-- TOC entry 264 (class 1255 OID 17670)
-- Dependencies: 5 808
...
--
-- TOC entry 263 (class 1255 OID 17668)
-- Dependencies: 808 5
...
--
-- TOC entry 260 (class 1255 OID 17665)
-- Dependencies: 5 808
...
-- Dependencies: 2237 2238 2239 2240 2241 2242 2243 2244 2245 2246 2247 2248 2249 2250 2251 2252 2253 2254 2255 2256 2257 2258 2259 2260 2261 2262 2263 5 1741 1741
...
--
-- TOC entry 262 (class 1255 OID 17664)
-- Dependencies: 5 808
...
--
-- TOC entry 244 (class 1255 OID 16799)
-- Dependencies: 5 808
...
-- Dependencies: 2276 2277 2278 2279 2280 5
...
--
-- TOC entry 261 (class 1255 OID 17663)
-- Dependencies: 670 5 808
...
--
-- TOC entry 303 (class 1255 OID 26958)
-- Dependencies: 808 5
...
--
-- TOC entry 311 (class 1255 OID 26976)
-- Dependencies: 808 5
...
--
-- TOC entry 306 (class 1255 OID 26933)
-- Dependencies: 5 808
...
CREATE FUNCTION xxxfun_contacts_table(inidcontact integer, inenable boolean, intitle text, infirstname text, inlastname text, ingender integer, inbirthday date, intypeofid integer, inidentification text, inweb text, inemail1 text, inemail2 text, inidaddress text, note text, OUT outreturn integer, OUT outpgmsg text) RETURNS record
    LANGUAGE plpgsql
    AS $$DECLARE
...
IF internalIdContact = inidcontact OR internalIdContact < 1 THEN
UPDATE contacts SET enable = inenable, title = intitle, firstname =infirstname, lastname = inlastname, gender = ingender, birthday = inbirthday, typeofid = intypeofid, identification = inidentification, web = inweb, email1 = inemail1, email2 = inemail2, note = innote, idaddress = indaddress WHERE idcontact = inidcontact RETURNING idcontact INTO outreturn;
outpgmsg := 'idcontact '||inidaccount::text||' actualizado.';
ELSE
outreturn := inidcontact;
outpgmsg := 'El nombre '||infirstname::text||' '||inlastname::text||' ya existe, utilice otro nombre';
END IF;
...
-- Insertamos un nuevo registro
	WHEN inidcontact = 0 THEN
IF internalIdContact < 1 THEN
INSERT INTO contact (enable, title, firstname, lastname, gender, birthday, typeofid, identification, web, email1, email2, note, idaddress) VALUES (inenable, intitle, infirstname, inlastname, ingender, inbirthday, intypeofid, inidentification, inweb, inemail1, inemail2, innote, inidaddress) RETURNING idcontact INTO outreturn;
outpgmsg := 'idcontact '||outreturn::text||' creado.';
ELSE
outreturn := -1;
outpgmsg := 'El nombre '||infirstname::text||' '||inlastname::text||' ya existe, utilice otro nombre';
...
DELETE FROM contacts WHERE idcontact = abs(inidcontact);
outreturn := abs(inidcontact);
outpgmsg := 'idcontact '||inidaccount::text||' eliminado.';
...
-- Dependencies: 306
-- Name: FUNCTION xxxfun_contacts_table(inidcontact integer, inenable boolean, intitle text, infirstname text, inlastname text, ingender integer, inbirthday date, intypeofid integer, inidentification text, inweb text, inemail1 text, inemail2 text, inidaddress text, note text, OUT outreturn integer, OUT outpgmsg text); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION xxxfun_contacts_table(inidcontact integer, inenable boolean, intitle text, infirstname text, inlastname text, ingender integer, inbirthday date, intypeofid integer, inidentification text, inweb text, inemail1 text, inemail2 text, inidaddress text, note text, OUT outreturn integer, OUT outpgmsg text) IS 'Funcion para editar, agregar y eliminar registros de la tabla contacts';


--
-- TOC entry 308 (class 1255 OID 26963)
-- Dependencies: 5 808
-- Name: xxxfun_contacts_table_xml(integer, boolean, text, text, text, integer, date, integer, text, text, text, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxfun_contacts_table_xml(inidcontact integer, inenable boolean, intitle text, infirstname text, inlastname text, ingender integer, inbirthday date, intypeofid integer, inidentification text, inweb text, inemail1 text, inemail2 text, inidaddress text, note text) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
OPEN CursorResultado FOR SELECT * FROM fun_contacts_table_xml(inidcontact, inenable, intitle, infirstname, inlastname, ingender, inbirthday, intypeofid, inidentification, inweb, inemail1, inemail2, inidaddress, innote);
SELECT * FROM cursor_to_xml(CursorResultado, 10, false, false, '') INTO Retorno;
CLOSE CursorResultado;
RETURN '<table>'||Retorno||'</table>';
END;$$;
...
--
-- TOC entry 251 (class 1255 OID 26977)
-- Dependencies: 5 808
-- Name: xxxfun_phones_table_xml(integer, integer, boolean, text, integer, integer, real, real, text, text, text, integer, text, timestamp without time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxfun_phones_table_xml(inidphone integer, inidcontact integer, inenable boolean, inphone text, intypephone integer, inidprovider integer, ingeox real, ingeoy real, inphone_ext text, inidaddress text, inaddress text, inubiphone integer, innote text, ts timestamp without time zone) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- TOC entry 292 (class 1255 OID 26865)
-- Dependencies: 808 5
-- Name: xxxstoreopeninghours_tostring(numeric); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxstoreopeninghours_tostring(open_id numeric, OUT a text, OUT b text, OUT c text) RETURNS SETOF record
    LANGUAGE plpgsql STABLE STRICT
    AS $$
BEGIN
...
--
-- TOC entry 309 (class 1255 OID 26965)
-- Dependencies: 5 808
...
CREATE FUNCTION xxxxfun_contacts_table(inidcontact integer, inenable boolean, intitle text, infirstname text, inlastname text, ingender integer, inbirthday date, intypeofid integer, inidentification text, inweb text, inemail1 text, inemail2 text, inidaddress text, innote text, OUT outreturn integer, OUT outpgmsg text) RETURNS record
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- TOC entry 247 (class 1255 OID 26964)
-- Dependencies: 5 808
-- Name: xxxxfun_contacts_table_xml(integer, boolean, text, text, text, integer, date, integer, text, text, text, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxxfun_contacts_table_xml(inidcontact integer, inenable boolean, intitle text, infirstname text, inlastname text, ingender integer, inbirthday date, intypeofid integer, inidentification text, inweb text, inemail1 text, inemail2 text, inidaddress text, innote text) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
OPEN CursorResultado FOR SELECT * FROM fun_contacts_table_xml(inidcontact, inenable, intitle, infirstname, inlastname, ingender, inbirthday, intypeofid, inidentification, inweb, inemail1, inemail2, inidaddress, innote, fieldtextasbase64);
SELECT * FROM cursor_to_xml(CursorResultado, 10, false, false, '') INTO Retorno;
CLOSE CursorResultado;
RETURN '<table>'||Retorno||'</table>';
END;$$;
...
-- Dependencies: 2294 2295 2296 2297 2298 2299 2300 2301 2302 7 1741
...
-- Dependencies: 2402 2403 2404 2405 2406 2407 2408 1739 7
...
-- Dependencies: 2303 2304 2305 2306 2307 2308 2309 2310 2311 7
...
-- Dependencies: 2319 2320 2321 2322 2323 2324 2325 1741 7
...
-- Dependencies: 2327 2328 2329 2330 2331 2332 2333 2334 1741 1741 7
...
-- Dependencies: 2421 2422 2423 2424 2425 2426 2427 1741 7
...
-- Dependencies: 2415 2416 2417 2418 2419 203 1741 1741 1739 7
...
-- Dependencies: 2339 2340 2341 2342 2343 2344 2345 2346 2348 2349 2350 2351 2352 2353 2354 2355 2356 2357 2358 2359 1741 7
...
-- Dependencies: 2360 2361 2362 2363 2364 2365 2366 2367 7
...
-- Dependencies: 2454 2455 2456 2457 1741 7 1741
...
-- Dependencies: 2369 2370 2371 2372 2373 1741 7
...
-- Dependencies: 2442 2443 2444 1739 1739 7
...
-- Dependencies: 2313 2314 2315 2316 2317 7
...
-- Dependencies: 2185 2186 2187 2188 2189 2190 2191 2192 2193 2194 2195 2196 2197 2198 2199 5
...
-- Dependencies: 2201 2202 2203 2204 2205 2206 2207 2208 2209 2210 2211 2212 2213 5 1741
...
--
-- TOC entry 214 (class 1259 OID 26177)
-- Dependencies: 2438 2439 2440 5 1741
...
--
-- TOC entry 210 (class 1259 OID 26134)
-- Dependencies: 2429 2430 2431 5
...
--
-- TOC entry 218 (class 1259 OID 26237)
-- Dependencies: 2446 2447 2448 1739 5
...
--
-- TOC entry 217 (class 1259 OID 26235)
-- Dependencies: 218 5
...
--
-- TOC entry 212 (class 1259 OID 26156)
...
--
-- TOC entry 220 (class 1259 OID 26257)
-- Dependencies: 2450 2451 2452 5 1741
...
-- Dependencies: 2269 2270 2271 1741 5
...
--
-- TOC entry 213 (class 1259 OID 26175)
-- Dependencies: 5 214
...
--
-- TOC entry 209 (class 1259 OID 26132)
-- Dependencies: 5 210
...
-- Dependencies: 2282 2283 2284 2285 2286 2287 2288 2289 2290 2291 2292 5
...
-- Dependencies: 2375 2376 2377 2378 2379 1741 1741 5 1741
...
-- Dependencies: 2215 2216 2217 2218 2219 5
...
-- Dependencies: 2221 2222 2223 2224 2225 2226 2227 2228 2229 2230 2231 2232 2233 2234 2235 1741 1741 5
...
--
-- TOC entry 211 (class 1259 OID 26154)
-- Dependencies: 5 212
...
-- Dependencies: 2176 1739 1741 1741 5
...
--
-- TOC entry 222 (class 1259 OID 26340)
-- Dependencies: 2177 5 1741
...
-- Dependencies: 2265 2266 2267 1741 5
...
--
-- TOC entry 2293 (class 2604 OID 16979)
...
--
-- TOC entry 2318 (class 2604 OID 17146)
...
--
-- TOC entry 2326 (class 2604 OID 17179)
...
--
-- TOC entry 2335 (class 2604 OID 17264)
...
--
-- TOC entry 2409 (class 2604 OID 18090)
...
--
-- TOC entry 2410 (class 2604 OID 18091)
-- Dependencies: 205 205
...
--
-- TOC entry 2411 (class 2604 OID 18092)
-- Dependencies: 205 205
...
--
-- TOC entry 2412 (class 2604 OID 18093)
-- Dependencies: 205 205
...
--
-- TOC entry 2413 (class 2604 OID 18094)
-- Dependencies: 205 205
...
--
-- TOC entry 2414 (class 2604 OID 18095)
-- Dependencies: 205 205
...
--
-- TOC entry 2420 (class 2604 OID 26457)
-- Dependencies: 205 205
...
--
-- TOC entry 2347 (class 2604 OID 17292)
...
--
-- TOC entry 2391 (class 2604 OID 17717)
...
--
-- TOC entry 2392 (class 2604 OID 17718)
...
--
-- TOC entry 2393 (class 2604 OID 17719)
-- Dependencies: 202 202
-- Name: idaccount; Type: DEFAULT; Schema: opensaga; Owner: -
--
...
--
-- TOC entry 2394 (class 2604 OID 17720)
-- Dependencies: 202 202
...
--
-- TOC entry 2395 (class 2604 OID 17721)
-- Dependencies: 202 202
...
--
-- TOC entry 2396 (class 2604 OID 17722)
-- Dependencies: 202 202
...
--
-- TOC entry 2397 (class 2604 OID 17723)
-- Dependencies: 202 202
...
--
-- TOC entry 2398 (class 2604 OID 17724)
-- Dependencies: 202 202
...
--
-- TOC entry 2400 (class 2604 OID 18022)
-- Dependencies: 202 202
...
--
-- TOC entry 2380 (class 2604 OID 25925)
-- Dependencies: 202 202
...
--
-- TOC entry 2381 (class 2604 OID 25942)
-- Dependencies: 202 202
...
--
-- TOC entry 2382 (class 2604 OID 25959)
-- Dependencies: 202 202
...
--
-- TOC entry 2383 (class 2604 OID 25976)
-- Dependencies: 202 202
...
--
-- TOC entry 2384 (class 2604 OID 25993)
-- Dependencies: 202 202
...
--
-- TOC entry 2385 (class 2604 OID 26010)
-- Dependencies: 202 202
-- Name: note; Type: DEFAULT; Schema: opensaga; Owner: -
--
...
--
-- TOC entry 2386 (class 2604 OID 26033)
-- Dependencies: 202 202
...
--
-- TOC entry 2387 (class 2604 OID 26050)
-- Dependencies: 202 202
...
--
-- TOC entry 2388 (class 2604 OID 26067)
-- Dependencies: 202 202
...
--
-- TOC entry 2389 (class 2604 OID 26084)
-- Dependencies: 202 202
...
--
-- TOC entry 2390 (class 2604 OID 26101)
-- Dependencies: 202 202
...
--
-- TOC entry 2401 (class 2604 OID 26572)
-- Dependencies: 202 202
-- Name: ts; Type: DEFAULT; Schema: opensaga; Owner: -
--
...
--
-- TOC entry 2453 (class 2604 OID 26384)
...
--
-- TOC entry 2368 (class 2604 OID 17392)
...
--
-- TOC entry 2441 (class 2604 OID 26205)
...
--
-- TOC entry 2312 (class 2604 OID 17111)
...
--
-- TOC entry 2437 (class 2604 OID 26180)
...
--
-- TOC entry 2428 (class 2604 OID 26137)
...
--
-- TOC entry 2445 (class 2604 OID 26240)
...
--
-- TOC entry 2432 (class 2604 OID 26159)
...
--
-- TOC entry 2449 (class 2604 OID 26260)
...
--
-- TOC entry 2268 (class 2604 OID 16625)
...
--
-- TOC entry 2184 (class 2604 OID 16390)
...
--
-- TOC entry 2281 (class 2604 OID 16836)
...
--
-- TOC entry 2374 (class 2604 OID 17585)
...
--
-- TOC entry 2200 (class 2604 OID 16426)
...
--
-- TOC entry 2214 (class 2604 OID 16455)
...
--
-- TOC entry 2220 (class 2604 OID 16525)
...
--
-- TOC entry 2236 (class 2604 OID 16582)
...
--
-- TOC entry 2275 (class 2604 OID 16748)
...
--
-- TOC entry 2264 (class 2604 OID 16602)
...
--
-- TOC entry 2518 (class 2606 OID 18076)
-- Dependencies: 203 203 203 2605
...
--
-- TOC entry 2550 (class 2606 OID 26454)
-- Dependencies: 227 227 227 2605
...
--
-- TOC entry 2522 (class 2606 OID 18120)
-- Dependencies: 206 206 206 2605
...
--
-- TOC entry 2520 (class 2606 OID 26886)
-- Dependencies: 205 205 205 2605
...
--
-- TOC entry 2482 (class 2606 OID 16987)
-- Dependencies: 184 184 2605
...
--
-- TOC entry 2504 (class 2606 OID 17295)
-- Dependencies: 195 195 2605
...
--
-- TOC entry 2514 (class 2606 OID 17730)
-- Dependencies: 202 202 2605
...
--
-- TOC entry 2506 (class 2606 OID 17362)
-- Dependencies: 196 196 2605
...
--
-- TOC entry 2546 (class 2606 OID 26392)
-- Dependencies: 225 225 2605
...
--
-- TOC entry 2488 (class 2606 OID 17061)
-- Dependencies: 185 185 2605
...
--
-- TOC entry 2508 (class 2606 OID 17399)
-- Dependencies: 198 198 2605
...
--
-- TOC entry 2494 (class 2606 OID 17156)
-- Dependencies: 189 189 2605
...
--
-- TOC entry 2498 (class 2606 OID 17182)
-- Dependencies: 191 191 2605
...
--
-- TOC entry 2502 (class 2606 OID 17266)
-- Dependencies: 193 193 2605
...
--
-- TOC entry 2536 (class 2606 OID 26212)
-- Dependencies: 216 216 2605
...
--
-- TOC entry 2492 (class 2606 OID 17119)
-- Dependencies: 187 187 2605
...
--
-- TOC entry 2500 (class 2606 OID 17988)
-- Dependencies: 191 191 191 2605
...
--
-- TOC entry 2484 (class 2606 OID 26363)
-- Dependencies: 184 184 2605
...
--
-- TOC entry 2486 (class 2606 OID 17949)
-- Dependencies: 184 184 2605
...
--
-- TOC entry 2516 (class 2606 OID 18043)
-- Dependencies: 202 202 202 202 202 2605
...
--
-- TOC entry 2490 (class 2606 OID 17073)
-- Dependencies: 185 185 2605
...
--
-- TOC entry 2496 (class 2606 OID 17173)
-- Dependencies: 189 189 2605
...
--
-- TOC entry 2548 (class 2606 OID 26394)
-- Dependencies: 225 225 2605
...
--
-- TOC entry 2464 (class 2606 OID 16428)
-- Dependencies: 167 167 2605
...
--
-- TOC entry 2462 (class 2606 OID 16400)
-- Dependencies: 165 165 2605
...
--
-- TOC entry 2532 (class 2606 OID 26187)
-- Dependencies: 214 214 2605
...
--
-- TOC entry 2474 (class 2606 OID 16632)
-- Dependencies: 177 177 2605
...
--
-- TOC entry 2524 (class 2606 OID 26142)
-- Dependencies: 210 210 2605
...
--
-- TOC entry 2476 (class 2606 OID 16704)
-- Dependencies: 178 178 2605
...
--
-- TOC entry 2480 (class 2606 OID 16845)
-- Dependencies: 182 182 2605
...
--
-- TOC entry 2510 (class 2606 OID 17587)
-- Dependencies: 201 201 2605
...
--
-- TOC entry 2466 (class 2606 OID 16464)
-- Dependencies: 169 169 2605
...
--
-- TOC entry 2538 (class 2606 OID 26247)
-- Dependencies: 218 218 2605
...
--
-- TOC entry 2468 (class 2606 OID 16528)
-- Dependencies: 171 171 2605
...
--
-- TOC entry 2478 (class 2606 OID 16756)
-- Dependencies: 180 180 2605
...
--
-- TOC entry 2528 (class 2606 OID 26167)
-- Dependencies: 212 212 2605
...
--
-- TOC entry 2542 (class 2606 OID 26267)
-- Dependencies: 220 220 2605
...
--
-- TOC entry 2472 (class 2606 OID 16609)
-- Dependencies: 175 175 2605
...
--
-- TOC entry 2470 (class 2606 OID 16596)
-- Dependencies: 173 173 2605
...
--
-- TOC entry 2540 (class 2606 OID 26249)
-- Dependencies: 218 218 218 2605
...
--
-- TOC entry 2544 (class 2606 OID 26269)
-- Dependencies: 220 220 220 2605
...
--
-- TOC entry 2534 (class 2606 OID 26229)
-- Dependencies: 214 214 214 2605
...
--
-- TOC entry 2530 (class 2606 OID 26222)
-- Dependencies: 212 212 212 2605
...
--
-- TOC entry 2512 (class 2606 OID 17624)
-- Dependencies: 201 201 2605
...
--
-- TOC entry 2526 (class 2606 OID 26153)
-- Dependencies: 210 210 2605
...
--
-- TOC entry 2583 (class 2620 OID 26838)
-- Dependencies: 290 184 2605
...
--
-- TOC entry 2593 (class 2620 OID 26839)
-- Dependencies: 203 290 2605
...
--
-- TOC entry 2584 (class 2620 OID 26840)
-- Dependencies: 185 290 2605
...
--
-- TOC entry 2586 (class 2620 OID 26841)
-- Dependencies: 290 189 2605
...
--
-- TOC entry 2587 (class 2620 OID 26842)
-- Dependencies: 290 191 2605
...
--
-- TOC entry 2588 (class 2620 OID 26843)
-- Dependencies: 290 193 2605
...
--
-- TOC entry 2603 (class 2620 OID 26844)
-- Dependencies: 290 227 2605
...
--
-- TOC entry 2595 (class 2620 OID 26845)
-- Dependencies: 206 290 2605
...
--
-- TOC entry 2594 (class 2620 OID 26846)
-- Dependencies: 290 205 2605
...
--
-- TOC entry 2589 (class 2620 OID 26847)
-- Dependencies: 195 290 2605
...
--
-- TOC entry 2590 (class 2620 OID 26848)
-- Dependencies: 196 290 2605
...
--
-- TOC entry 2602 (class 2620 OID 26849)
-- Dependencies: 225 290 2605
...
--
-- TOC entry 2591 (class 2620 OID 26850)
-- Dependencies: 290 198 2605
...
--
-- TOC entry 2599 (class 2620 OID 26851)
-- Dependencies: 216 290 2605
...
--
-- TOC entry 2585 (class 2620 OID 26852)
-- Dependencies: 187 290 2605
...
--
-- TOC entry 2598 (class 2620 OID 26822)
-- Dependencies: 290 214 2605
...
--
-- TOC entry 2596 (class 2620 OID 26824)
-- Dependencies: 290 210 2605
...
--
-- TOC entry 2600 (class 2620 OID 26825)
-- Dependencies: 218 290 2605
...
--
-- TOC entry 2597 (class 2620 OID 26827)
-- Dependencies: 212 290 2605
...
--
-- TOC entry 2601 (class 2620 OID 26826)
-- Dependencies: 220 290 2605
...
--
-- TOC entry 2580 (class 2620 OID 26828)
-- Dependencies: 177 290 2605
...
--
-- TOC entry 2573 (class 2620 OID 26829)
-- Dependencies: 165 290 2605
...
--
-- TOC entry 2582 (class 2620 OID 26830)
-- Dependencies: 182 290 2605
...
--
-- TOC entry 2592 (class 2620 OID 26831)
-- Dependencies: 201 290 2605
...
--
-- TOC entry 2575 (class 2620 OID 26816)
-- Dependencies: 290 167 2605
...
--
-- TOC entry 2574 (class 2620 OID 26832)
-- Dependencies: 167 290 2605
...
--
-- TOC entry 2576 (class 2620 OID 26833)
-- Dependencies: 290 169 2605
...
--
-- TOC entry 2577 (class 2620 OID 26834)
-- Dependencies: 290 171 2605
...
--
-- TOC entry 2578 (class 2620 OID 26835)
-- Dependencies: 173 290 2605
...
--
-- TOC entry 2581 (class 2620 OID 26836)
-- Dependencies: 180 290 2605
...
--
-- TOC entry 2579 (class 2620 OID 26837)
-- Dependencies: 290 175 2605
...
--
-- TOC entry 2567 (class 2606 OID 26561)
-- Dependencies: 206 184 2481 2605
...
--
-- TOC entry 2568 (class 2606 OID 26566)
-- Dependencies: 206 167 2463 2605
...
--
-- TOC entry 2565 (class 2606 OID 26887)
-- Dependencies: 205 184 2481 2605
...
--
-- TOC entry 2566 (class 2606 OID 26892)
-- Dependencies: 165 2461 205 2605
...
--
-- TOC entry 2556 (class 2606 OID 26491)
-- Dependencies: 184 185 2481 2605
...
--
-- TOC entry 2558 (class 2606 OID 26510)
-- Dependencies: 184 189 2481 2605
-- Name: fk_idaccount; Type: FK CONSTRAINT; Schema: opensaga; Owner: -
--
...
--
-- TOC entry 2563 (class 2606 OID 26921)
-- Dependencies: 203 2481 184 2605
...
--
-- TOC entry 2559 (class 2606 OID 26871)
-- Dependencies: 184 191 2481 2605
...
--
-- TOC entry 2564 (class 2606 OID 26926)
-- Dependencies: 2461 165 203 2605
...
--
-- TOC entry 2562 (class 2606 OID 26614)
-- Dependencies: 2505 196 198 2605
...
--
-- TOC entry 2561 (class 2606 OID 26540)
-- Dependencies: 193 191 2497 2605
...
--
-- TOC entry 2557 (class 2606 OID 26496)
-- Dependencies: 185 2491 187 2605
...
--
-- TOC entry 2560 (class 2606 OID 26876)
-- Dependencies: 167 191 2463 2605
...
--
-- TOC entry 2571 (class 2606 OID 26667)
-- Dependencies: 2531 218 214 2605
...
--
-- TOC entry 2551 (class 2606 OID 26817)
-- Dependencies: 165 2461 167 2605
...
--
-- TOC entry 2569 (class 2606 OID 26681)
-- Dependencies: 2523 212 210 2605
...
--
-- TOC entry 2554 (class 2606 OID 26709)
-- Dependencies: 2463 167 177 2605
...
--
-- TOC entry 2552 (class 2606 OID 26805)
-- Dependencies: 2463 175 167 2605
-- Name: fk_idphone; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2555 (class 2606 OID 26714)
-- Dependencies: 2465 177 169 2605
...
--
-- TOC entry 2553 (class 2606 OID 26810)
-- Dependencies: 2465 169 175 2605
-- Name: fk_idprovider; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2572 (class 2606 OID 26696)
-- Dependencies: 2537 218 220 2605
...
--
-- TOC entry 2570 (class 2606 OID 26644)
-- Dependencies: 214 2527 212 2605
...
-- Completed on 2013-01-08 15:40:03 ECT
