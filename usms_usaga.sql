...
-- Started on 2013-02-25 08:39:13 ECT
...
--
-- TOC entry 2721 (class 1262 OID 16384)
-- Dependencies: 2720
...
--
-- TOC entry 338 (class 1255 OID 27314)
-- Dependencies: 5 876
...
--
-- TOC entry 332 (class 1255 OID 27319)
-- Dependencies: 5 876
...
--
-- TOC entry 298 (class 1255 OID 26962)
-- Dependencies: 5 876
...
--
-- TOC entry 346 (class 1255 OID 27267)
-- Dependencies: 876 5
...
--
-- TOC entry 331 (class 1255 OID 27268)
-- Dependencies: 5 876
...
--
-- TOC entry 372 (class 1255 OID 27603)
-- Dependencies: 5 876
...
--
-- TOC entry 328 (class 1255 OID 27607)
-- Dependencies: 5 876
...
--
-- TOC entry 329 (class 1255 OID 27608)
-- Dependencies: 876 5
...
--
-- TOC entry 375 (class 1255 OID 27617)
-- Dependencies: 5 876
...
--
-- TOC entry 301 (class 1255 OID 26980)
-- Dependencies: 5 876
...
--
-- TOC entry 251 (class 1255 OID 27318)
-- Dependencies: 5 876
...
--
-- TOC entry 333 (class 1255 OID 27320)
-- Dependencies: 5 876
...
--
-- TOC entry 347 (class 1255 OID 27274)
-- Dependencies: 876 5
...
--
-- TOC entry 303 (class 1255 OID 26982)
-- Dependencies: 5 876
...
-- Dependencies: 2297 2298 2299 2300 2301 2302 2303 2304 2305 2306 2307 2308 2309 2310 2311 2312 2313 2314 2315 2316 2317 2318 2319 2320 2321 2322 2323 2324 1809 5 1809
...
-- Dependencies: 2337 2338 2339 2340 2341 5
...
--
-- TOC entry 334 (class 1255 OID 27273)
-- Dependencies: 5 876
...
--
-- TOC entry 366 (class 1255 OID 27432)
-- Dependencies: 876 5
-- Name: fun_view_city_by_idstate_xml(integer, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_view_city_by_idstate_xml(inidstate integer, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- TOC entry 354 (class 1255 OID 27388)
-- Dependencies: 5 876
-- Name: fun_view_city_xml(integer, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_view_city_xml(inidstate integer, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- TOC entry 300 (class 1255 OID 26959)
-- Dependencies: 876 5
...
--
-- TOC entry 295 (class 1255 OID 26958)
-- Dependencies: 876 5
...
--
-- TOC entry 302 (class 1255 OID 26983)
-- Dependencies: 5 876
...
--
-- TOC entry 377 (class 1255 OID 27622)
-- Dependencies: 876 5
...
--
-- TOC entry 299 (class 1255 OID 26976)
-- Dependencies: 876 5
...
--
-- TOC entry 307 (class 1255 OID 27021)
-- Dependencies: 5 876
...
--
-- TOC entry 367 (class 1255 OID 27433)
-- Dependencies: 5 876
-- Name: fun_view_sector_by_idcity_xml(integer, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_view_sector_by_idcity_xml(inidcity integer, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
-- Dependencies: 5 876
-- Name: fun_view_sector_xml(integer, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_view_sector_xml(inidcity integer, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- TOC entry 309 (class 1255 OID 27038)
-- Dependencies: 876 5
...
--
-- TOC entry 358 (class 1255 OID 27387)
-- Dependencies: 876 5
-- Name: fun_view_state_by_idcountry_xml(integer, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_view_state_by_idcountry_xml(inidcountry integer, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
-- Dependencies: 876 5
-- Name: fun_view_subsector_by_idsector_xml(integer, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_view_subsector_by_idsector_xml(inidsector integer, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- TOC entry 255 (class 1255 OID 27390)
-- Dependencies: 5 876
-- Name: fun_view_subsector_xml(integer, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_view_subsector_xml(inidsector integer, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- TOC entry 340 (class 1255 OID 27333)
-- Dependencies: 876 5
...
--
-- TOC entry 325 (class 1255 OID 27428)
-- Dependencies: 5 876
-- Name: xxxfun_location_city_edit_xml(integer, integer, text, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxfun_location_city_edit_xml(inidstate integer, inidcity integer, inname text, incode text, ints timestamp without time zone, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
-- Verificamos que el nombre no se repita en otro registro
IF length(inname) > 2 AND NOT EXISTS(SELECT * FROM location_city WHERE name = inname AND idcity != inidcity)  THEN
namevalid := TRUE;
END IF;
...
WHEN inidcity = 0 THEN   

IF namevalid AND EXISTS(SELECT * FROM location_states WHERE idstate = inidstate) THEN
INSERT INTO location_city (idstate, name, code) VALUES (inidstate, inname, incode) RETURNING idcity INTO outreturn;
outpgmsg := 'Nuevo registro creado, id = '||outreturn::text;
ELSE
outreturn:= 0;
outpgmsg := 'El nombre '||inname::text||' no es válido, el nombre no debe estar vacio o repetirse en otro registro.';
...
IF namevalid THEN
UPDATE location_city SET name = inname, code = incode WHERE idcity = inidcity RETURNING idcity INTO outreturn;
outpgmsg := 'Registro actualizado';
ELSE
outreturn:= 0;
outpgmsg := 'El nombre '||inname::text||' no es válido, el nombre no debe estar vacio o repetirse en otro registro.';
...
--
-- TOC entry 256 (class 1255 OID 27424)
-- Dependencies: 5 876
-- Name: xxxfun_location_city_remove_selected_xml(integer[], boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxfun_location_city_remove_selected_xml(ids integer[], fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
outpgmsg TEXT DEFAULT 'Ninguna accion realizada';
outreturn INTEGER DEFAULT 0;
...
IF EXISTS(SELECT * FROM location_city WHERE idcity = ids[i]) THEN
DELETE FROM location_city WHERE idcity = ids[i];
outreturn := outreturn+1;
END IF;
...
--
-- TOC entry 362 (class 1255 OID 27416)
-- Dependencies: 5 876
-- Name: xxxfun_location_country_edit_xml(integer, text, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxfun_location_country_edit_xml(inidcountry integer, inname text, incode text, ints timestamp without time zone, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
-- Verificamos que el nombre no se repita en otro registro
IF length(inname) > 2 AND NOT EXISTS(SELECT * FROM location_country WHERE name = inname AND idcountry != inidcountry)  THEN
namevalid := TRUE;
END IF;
...
WHEN inidcountry = 0 THEN   

IF namevalid THEN
INSERT INTO location_country (name, code) VALUES (inname, incode) RETURNING idcountry INTO outreturn;
outpgmsg := 'Nuevo registro creado, idcountry = '||outreturn::text;
ELSE
outreturn:= 0;
outpgmsg := 'El nombre '||inname::text||' no es válido, el nombre no debe estar vacio o repetirse en otro registro.';
END IF;
...
IF namevalid THEN
UPDATE location_country SET name = inname, code = incode WHERE idcountry = inidcountry RETURNING idcountry INTO outreturn;
outpgmsg := 'Registro actualizado';
ELSE
outreturn:= 0;
outpgmsg := 'El nombre '||inname::text||' no es válido, el nombre no debe estar vacio o repetirse en otro registro.';
...
--
-- TOC entry 360 (class 1255 OID 27419)
-- Dependencies: 876 5
-- Name: xxxfun_location_country_remove_selected_xml(integer[], boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxfun_location_country_remove_selected_xml(ids integer[], fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
outpgmsg TEXT DEFAULT 'Ninguna accion realizada';
outreturn INTEGER DEFAULT 0;
...
IF EXISTS(SELECT * FROM location_country WHERE idcountry = ids[i]) THEN
DELETE FROM location_country WHERE idcountry = ids[i];
outreturn := outreturn+1;
END IF;
...
--
-- TOC entry 365 (class 1255 OID 27429)
-- Dependencies: 5 876
-- Name: xxxfun_location_sector_edit_xml(integer, integer, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxfun_location_sector_edit_xml(inidcity integer, inidsector integer, inname text, ints timestamp without time zone, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
-- Verificamos que el nombre no se repita en otro registro
IF length(inname) > 2 AND NOT EXISTS(SELECT * FROM location_sector WHERE name = inname AND idsector != inidsector)  THEN
namevalid := TRUE;
END IF;
...
WHEN inidsector = 0 THEN   

IF namevalid AND EXISTS(SELECT * FROM location_city WHERE idcity = inidcity) THEN
INSERT INTO location_sector (idcity, name) VALUES (inidcity, inname) RETURNING idsector INTO outreturn;
outpgmsg := 'Nuevo registro creado, id = '||outreturn::text;
ELSE
outreturn:= 0;
outpgmsg := 'El nombre '||inname::text||' no es válido, el nombre no debe estar vacio o repetirse en otro registro.';
...
IF namevalid THEN
UPDATE location_sector SET name = inname WHERE idsector = inidsector RETURNING idsector INTO outreturn;
outpgmsg := 'Registro actualizado';
ELSE
outreturn:= 0;
outpgmsg := 'El nombre '||inname::text||' no es válido, el nombre no debe estar vacio o repetirse en otro registro.';
...
--
-- TOC entry 373 (class 1255 OID 27386)
-- Dependencies: 876 5
-- Name: xxxfun_view_location_level1_xml(boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxfun_view_location_level1_xml(fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
OPEN CursorResult FOR SELECT idl1, encode(name::bytea, 'base64') as name, encode(code::bytea, 'base64') as code, ts FROM location_level1;
SELECT * FROM cursor_to_xml(CursorResult, 1000, false, false, '') INTO Retorno;
CLOSE CursorResult;

ELSE

OPEN CursorResult FOR SELECT * FROM location_level1;
SELECT * FROM cursor_to_xml(CursorResult, 1000, false, false, '') INTO Retorno;
CLOSE CursorResult;
...
--
-- TOC entry 374 (class 1255 OID 27604)
-- Dependencies: 5 876
-- Name: xxxxfun_location_level1_remove_selected_xml(integer[], boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxxfun_location_level1_remove_selected_xml(ids integer[], fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
outpgmsg TEXT DEFAULT 'Ninguna accion realizada';
outreturn INTEGER DEFAULT 0;
...
IF EXISTS(SELECT * FROM location_level1 WHERE idl1 = ids[i]) THEN
DELETE FROM location_level1 WHERE idl1 = ids[i];
outreturn := outreturn+1;
END IF;
...
--
-- TOC entry 324 (class 1255 OID 27606)
-- Dependencies: 5 876
-- Name: xxxxfun_location_level_edit_xml(integer, integer, integer, text, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxxfun_location_level_edit_xml(l integer, idpk integer, idfk integer, inname text, incode text, ints timestamp without time zone, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $_$DECLARE
...
namepk  TEXT DEFAULT 'pk';
namefk TEXT DEFAULT 'fk';
nametablepk TEXT DEFAULT 'tpk';
nametablefk TEXT DEFAULT 'tfk';


BEGIN

IF l > 1 THEN
-- Seteamos las variables de tablas y nombres que se van a usar
CASE

WHEN l = 2 THEN
namepk:= 'idl2';
namefk:= 'idl1';
nametablepk:= 'location_level2';
nametablefk:= 'location_level1';

WHEN l = 3 THEN
namepk:= 'idl3';
namefk:= 'idl2';
nametablepk:= 'location_level3';
nametablefk:= 'location_level2';

WHEN l = 4 THEN
namepk:= 'idl4';
namefk:= 'idl3';
nametablepk:= 'location_level4';
nametablefk:= 'location_level3';


WHEN l = 5 THEN
namepk:= 'idl5';
namefk:= 'idl4';
nametablepk:= 'location_level5';
nametablefk:= 'location_level4';


WHEN l = 6 THEN
namepk:= 'idl6';
namefk:= 'idl5';
nametablepk:= 'location_level6';
nametablefk:= 'location_level5';

ELSE
outreturn := 0;
outpgmsg := 'Esta funcion es válida para los niveles 2, 3, 4, 5, 6';
END CASE;


-- Verificamos que el nombre no se repita en otro registro
IF length(inname) > 2 AND NOT EXECUTE ('EXISTS(SELECT * FROM $nametablepk WHERE name = inname AND $namepk != idpk)')  THEN

CASE

WHEN idpk = 0 THEN   

IF EXISTS(SELECT * FROM nametablefk WHERE nametablefk = idfk) THEN
INSERT INTO nametablepk (namefk, name, code) VALUES (idfk, inname, incode) RETURNING namepk INTO outreturn;
outpgmsg := 'Nuevo registro creado, id = '||outreturn::text;
ELSE
outreturn:= 0;
outpgmsg := 'No se insertado un nuevo registro porque la llave foranea '||namefk::text||' = '||idfk::text||' no existe';
END IF;

WHEN idpk > 0 THEN

UPDATE nametablepk SET name = inname, code = incode WHERE namepk = idpk RETURNING namepk INTO outreturn;
outpgmsg := 'Registro actualizado';
...
--
-- TOC entry 363 (class 1255 OID 27425)
-- Dependencies: 876 5
-- Name: xxxxfun_location_sector_remove_selected_xml(integer[], boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxxfun_location_sector_remove_selected_xml(ids integer[], fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
outpgmsg TEXT DEFAULT 'Ninguna accion realizada';
outreturn INTEGER DEFAULT 0;
...
IF EXISTS(SELECT * FROM location_sector WHERE idsector = ids[i]) THEN
DELETE FROM location_sector WHERE idsector = ids[i];
outreturn := outreturn+1;
END IF;
...
--
-- TOC entry 257 (class 1255 OID 27427)
-- Dependencies: 5 876
-- Name: xxxxfun_location_state_edit_xml(integer, integer, text, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxxfun_location_state_edit_xml(inidcountry integer, inidstate integer, inname text, incode text, ints timestamp without time zone, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
-- Verificamos que el nombre no se repita en otro registro
IF length(inname) > 2 AND NOT EXISTS(SELECT * FROM location_states WHERE name = inname AND idstate != inidstate)  THEN
namevalid := TRUE;
END IF;
...
WHEN inidstate = 0 THEN   

IF namevalid AND EXISTS(SELECT * FROM location_country WHERE idcountry = inidcountry) THEN
INSERT INTO location_states (idcountry, name, code) VALUES (inidcountry, inname, incode) RETURNING idstate INTO outreturn;
outpgmsg := 'Nuevo registro creado, id = '||outreturn::text;
ELSE
outreturn:= 0;
outpgmsg := 'El nombre '||inname::text||' no es válido, el nombre no debe estar vacio o repetirse en otro registro.';
...
IF namevalid THEN
UPDATE location_states SET name = inname, code = incode WHERE idstate = inidstate RETURNING idstate INTO outreturn;
outpgmsg := 'Registro actualizado';
ELSE
outreturn:= 0;
outpgmsg := 'El nombre '||inname::text||' no es válido, el nombre no debe estar vacio o repetirse en otro registro.';
...
--
-- TOC entry 368 (class 1255 OID 27431)
-- Dependencies: 5 876
-- Name: xxxxfun_location_state_remove_selected_xml(integer[], boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxxfun_location_state_remove_selected_xml(ids integer[], fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
outpgmsg TEXT DEFAULT 'Ninguna accion realizada';
outreturn INTEGER DEFAULT 0;
...
IF EXISTS(SELECT * FROM location_states WHERE idstate = ids[i]) THEN
DELETE FROM location_states WHERE idstate = ids[i];
outreturn := outreturn+1;
END IF;
...
--
-- TOC entry 364 (class 1255 OID 27426)
-- Dependencies: 876 5
-- Name: xxxxfun_location_subsector_remove_selected_xml(integer[], boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxxfun_location_subsector_remove_selected_xml(ids integer[], fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
outpgmsg TEXT DEFAULT 'Ninguna accion realizada';
outreturn INTEGER DEFAULT 0;
...
IF EXISTS(SELECT * FROM location_subsector WHERE idsubsector = ids[i]) THEN
DELETE FROM location_subsector WHERE idsubsector = ids[i];
outreturn := outreturn+1;
END IF;
...
--
-- TOC entry 376 (class 1255 OID 27430)
-- Dependencies: 5 876
-- Name: xxxxxfun_location_subsector_edit_xml(integer, integer, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxxxfun_location_subsector_edit_xml(inidsector integer, inidsubsector integer, inname text, ints timestamp without time zone, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
-- Verificamos que el nombre no se repita en otro registro
IF length(inname) > 2 AND NOT EXISTS(SELECT * FROM location_subsector WHERE name = inname AND idsubsector != inidsubsector)  THEN
namevalid := TRUE;
END IF;
...
WHEN inidsubsector = 0 THEN   

IF namevalid AND EXISTS(SELECT * FROM location_sector WHERE idsector = inidsector) THEN
INSERT INTO location_subsector (idsector, name) VALUES (inidsector, inname) RETURNING idsubsector INTO outreturn;
outpgmsg := 'Nuevo registro creado, id = '||outreturn::text;
ELSE
outreturn:= 0;
outpgmsg := 'El nombre '||inname::text||' no es válido, el nombre no debe estar vacio o repetirse en otro registro.';
...
IF namevalid THEN
UPDATE location_subsector SET name = inname WHERE idsubsector = inidsubsector RETURNING idsubsector INTO outreturn;
outpgmsg := 'Registro actualizado';
ELSE
outreturn:= 0;
outpgmsg := 'El nombre '||inname::text||' no es válido, el nombre no debe estar vacio o repetirse en otro registro.';
...
--
-- TOC entry 361 (class 1255 OID 27420)
-- Dependencies: 876 5
-- Name: xxxxxxfun_state_remove_selected_xml(integer[], boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxxxxfun_state_remove_selected_xml(ids integer[], fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
outpgmsg TEXT DEFAULT 'Ninguna accion realizada';
outreturn INTEGER DEFAULT 0;
...
IF EXISTS(SELECT * FROM location_state WHERE idcountry = ids[i]) THEN
DELETE FROM location_state WHERE idstate = ids[i];
outreturn := outreturn+1;
END IF;
...
--
-- TOC entry 341 (class 1255 OID 27315)
-- Dependencies: 9 876
-- Name: fun_account_address_edit(integer, integer, text, double precision, double precision, text, text, text, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: usaga; Owner: -
--

CREATE FUNCTION fun_account_address_edit(inidaccount integer, inidaddress integer, inidlocation text, ingeox double precision, ingeoy double precision, inmstreet text, insstreet text, inother text, innote text, ints timestamp without time zone, fieldtextasbase64 boolean, OUT outreturn integer, OUT outpgmsg text) RETURNS record
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- TOC entry 339 (class 1255 OID 27316)
-- Dependencies: 9 876
-- Name: fun_account_address_edit_xml(integer, integer, text, double precision, double precision, text, text, text, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: usaga; Owner: -
--

CREATE FUNCTION fun_account_address_edit_xml(idaccount integer, inidaddress integer, inidlocation text, ingeox double precision, ingeoy double precision, inmstreet text, insstreet text, inother text, innote text, ints timestamp without time zone, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- TOC entry 294 (class 1255 OID 26932)
-- Dependencies: 876 9
...
--
-- TOC entry 296 (class 1255 OID 26948)
-- Dependencies: 9 876
...
--
-- TOC entry 326 (class 1255 OID 27062)
-- Dependencies: 9 876
...
--
-- TOC entry 297 (class 1255 OID 26944)
-- Dependencies: 9 876
...
--
-- TOC entry 330 (class 1255 OID 27075)
-- Dependencies: 876 9
...
--
-- TOC entry 369 (class 1255 OID 27460)
-- Dependencies: 876 9
...
--
-- TOC entry 350 (class 1255 OID 27355)
-- Dependencies: 876 9
...
--
-- TOC entry 353 (class 1255 OID 27357)
-- Dependencies: 876 9
...
--
-- TOC entry 352 (class 1255 OID 27358)
-- Dependencies: 876 9
...
--
-- TOC entry 355 (class 1255 OID 27361)
-- Dependencies: 9 876
...
--
-- TOC entry 370 (class 1255 OID 27466)
-- Dependencies: 876 9
...
--
-- TOC entry 306 (class 1255 OID 27019)
-- Dependencies: 876 9
...
--
-- TOC entry 371 (class 1255 OID 27465)
-- Dependencies: 876 9
...
--
-- TOC entry 292 (class 1255 OID 26920)
-- Dependencies: 9 876
...
--
-- TOC entry 308 (class 1255 OID 26994)
-- Dependencies: 876 9
...
--
-- TOC entry 327 (class 1255 OID 27278)
-- Dependencies: 9 876
...
--
-- TOC entry 293 (class 1255 OID 27459)
-- Dependencies: 9 876
...
--
-- TOC entry 351 (class 1255 OID 27350)
-- Dependencies: 876 9
...
--
-- TOC entry 349 (class 1255 OID 27356)
-- Dependencies: 876 9
...
--
-- TOC entry 348 (class 1255 OID 27349)
-- Dependencies: 876 9
...
--
-- TOC entry 305 (class 1255 OID 26986)
-- Dependencies: 9 876
...
--
-- TOC entry 304 (class 1255 OID 26984)
-- Dependencies: 9 876
...
-- Dependencies: 2520 2521 2522 2523 2524 2525 2526 2527 5 1807 1807 1807 1807
...
-- Dependencies: 2330 2331 2332 1809 5
...
-- Dependencies: 2248 2249 2250 2251 2252 2253 2254 2255 2256 2257 2258 2259 2260 2261 5
...
-- Dependencies: 2343 2344 2345 2346 2347 2348 2349 2350 2351 2352 2353 5
...
-- Dependencies: 2489 2490 2491 2492 5
...
-- Dependencies: 2505 2506 2507 1807 1807 5
...
-- Dependencies: 2493 2494 2495 2496 5
...
-- Dependencies: 2508 2509 2510 5 1807 1809
...
-- Dependencies: 2497 2498 2499 1809 5
...
-- Dependencies: 2552 2553 2554 2555 5
...
-- Dependencies: 2436 2437 2438 2439 2440 1809 5 1809 1809
...
-- Dependencies: 2263 2264 2265 2266 2267 2268 2269 2270 2271 2272 2273 5
...
-- Dependencies: 2275 2276 2277 2278 2279 5
...
-- Dependencies: 2281 2282 2283 2284 2285 2286 2287 2288 2289 2290 2291 2292 2293 2294 2295 1809 5 1809
...
-- Dependencies: 2541 2542 2543 2544 2545 2546 2547 2548 2549 2550 2551 5
...
-- Dependencies: 2528 2530 2531 2532 2533 2534 2535 2536 2537 2538 2539 5
...
-- Dependencies: 2243 5 1809 1807 1809
...
-- Dependencies: 2326 2327 2328 5 1809
...
-- Dependencies: 2355 2356 2357 2358 2359 2360 2361 2362 2363 1809 9
...
-- Dependencies: 2463 2464 2465 2466 2467 2468 2469 1807 9
...
-- Dependencies: 2364 2365 2366 2367 2368 2369 2370 2371 2372 9
...
-- Dependencies: 2380 2381 2382 2383 2384 2385 2386 1809 9
...
-- Dependencies: 2388 2389 2390 2391 2392 2393 2394 2395 1809 9 1809
...
-- Dependencies: 2482 2483 2484 2485 2486 2487 2488 9 1809
...
-- Dependencies: 2476 2477 2478 2479 2480 1809 202 9 1809 1807
...
-- Dependencies: 2400 2401 2402 2403 2404 2405 2406 2407 2409 2410 2411 2412 2413 2414 2415 2416 2417 2418 2419 2420 1809 9
...
-- Dependencies: 2421 2422 2423 2424 2425 2426 2427 2428 9
...
-- Dependencies: 2512 2513 2514 2515 9 1809 1809
...
-- Dependencies: 2430 2431 2432 2433 2434 9 1809
...
-- Dependencies: 2502 2503 2504 1807 1807 9
...
-- Dependencies: 2374 2375 2376 2377 2378 9
...
--
-- TOC entry 2519 (class 2604 OID 27139)
...
--
-- TOC entry 2329 (class 2604 OID 16625)
...
--
-- TOC entry 2247 (class 2604 OID 16390)
...
--
-- TOC entry 2342 (class 2604 OID 16836)
...
--
-- TOC entry 2500 (class 2604 OID 27590)
...
--
-- TOC entry 2435 (class 2604 OID 17585)
...
--
-- TOC entry 2262 (class 2604 OID 16426)
...
--
-- TOC entry 2274 (class 2604 OID 16455)
...
--
-- TOC entry 2280 (class 2604 OID 16525)
...
--
-- TOC entry 2540 (class 2604 OID 27200)
...
--
-- TOC entry 2296 (class 2604 OID 16582)
...
--
-- TOC entry 2529 (class 2604 OID 27176)
...
--
-- TOC entry 2336 (class 2604 OID 16748)
...
--
-- TOC entry 2325 (class 2604 OID 16602)
...
--
-- TOC entry 2354 (class 2604 OID 16979)
...
--
-- TOC entry 2387 (class 2604 OID 17179)
...
--
-- TOC entry 2396 (class 2604 OID 17264)
...
--
-- TOC entry 2470 (class 2604 OID 18090)
...
--
-- TOC entry 2471 (class 2604 OID 18091)
-- Dependencies: 203 203
...
--
-- TOC entry 2472 (class 2604 OID 18092)
-- Dependencies: 203 203
...
--
-- TOC entry 2473 (class 2604 OID 18093)
-- Dependencies: 203 203
...
--
-- TOC entry 2474 (class 2604 OID 18094)
-- Dependencies: 203 203
...
--
-- TOC entry 2475 (class 2604 OID 18095)
-- Dependencies: 203 203
...
--
-- TOC entry 2481 (class 2604 OID 26457)
-- Dependencies: 203 203
...
--
-- TOC entry 2408 (class 2604 OID 17292)
...
--
-- TOC entry 2452 (class 2604 OID 17717)
...
--
-- TOC entry 2453 (class 2604 OID 17718)
...
--
-- TOC entry 2454 (class 2604 OID 17719)
-- Dependencies: 201 201
-- Name: idaccount; Type: DEFAULT; Schema: usaga; Owner: -
--
...
--
-- TOC entry 2455 (class 2604 OID 17720)
-- Dependencies: 201 201
...
--
-- TOC entry 2456 (class 2604 OID 17721)
-- Dependencies: 201 201
...
--
-- TOC entry 2457 (class 2604 OID 17722)
-- Dependencies: 201 201
...
--
-- TOC entry 2458 (class 2604 OID 17723)
-- Dependencies: 201 201
...
--
-- TOC entry 2459 (class 2604 OID 17724)
-- Dependencies: 201 201
...
--
-- TOC entry 2461 (class 2604 OID 18022)
-- Dependencies: 201 201
...
--
-- TOC entry 2441 (class 2604 OID 25925)
-- Dependencies: 201 201
...
--
-- TOC entry 2442 (class 2604 OID 25942)
-- Dependencies: 201 201
...
--
-- TOC entry 2443 (class 2604 OID 25959)
-- Dependencies: 201 201
...
--
-- TOC entry 2444 (class 2604 OID 25976)
-- Dependencies: 201 201
...
--
-- TOC entry 2445 (class 2604 OID 25993)
-- Dependencies: 201 201
...
--
-- TOC entry 2446 (class 2604 OID 26010)
-- Dependencies: 201 201
-- Name: note; Type: DEFAULT; Schema: usaga; Owner: -
--
...
--
-- TOC entry 2447 (class 2604 OID 26033)
-- Dependencies: 201 201
...
--
-- TOC entry 2448 (class 2604 OID 26050)
-- Dependencies: 201 201
...
--
-- TOC entry 2449 (class 2604 OID 26067)
-- Dependencies: 201 201
...
--
-- TOC entry 2450 (class 2604 OID 26084)
-- Dependencies: 201 201
...
--
-- TOC entry 2451 (class 2604 OID 26101)
-- Dependencies: 201 201
...
--
-- TOC entry 2462 (class 2604 OID 26572)
-- Dependencies: 201 201
-- Name: ts; Type: DEFAULT; Schema: usaga; Owner: -
--
...
--
-- TOC entry 2511 (class 2604 OID 26384)
...
--
-- TOC entry 2429 (class 2604 OID 17392)
...
--
-- TOC entry 2501 (class 2604 OID 26205)
...
--
-- TOC entry 2373 (class 2604 OID 17111)
...
--
-- TOC entry 2379 (class 2604 OID 17146)
...
--
-- TOC entry 2559 (class 2606 OID 16428)
-- Dependencies: 167 167 2717
...
--
-- TOC entry 2557 (class 2606 OID 16400)
-- Dependencies: 165 165 2717
...
--
-- TOC entry 2647 (class 2606 OID 27152)
-- Dependencies: 225 225 2717
...
--
-- TOC entry 2569 (class 2606 OID 16632)
-- Dependencies: 177 177 2717
...
--
-- TOC entry 2571 (class 2606 OID 16704)
-- Dependencies: 178 178 2717
...
--
-- TOC entry 2575 (class 2606 OID 16845)
-- Dependencies: 182 182 2717
...
--
-- TOC entry 2619 (class 2606 OID 27512)
-- Dependencies: 207 207 2717
...
--
-- TOC entry 2623 (class 2606 OID 27497)
-- Dependencies: 209 209 2717
...
--
-- TOC entry 2653 (class 2606 OID 27509)
-- Dependencies: 233 233 2717
...
--
-- TOC entry 2627 (class 2606 OID 27495)
-- Dependencies: 211 211 2717
...
--
-- TOC entry 2633 (class 2606 OID 27493)
-- Dependencies: 215 215 2717
...
--
-- TOC entry 2637 (class 2606 OID 27491)
-- Dependencies: 217 217 2717
...
--
-- TOC entry 2605 (class 2606 OID 17587)
-- Dependencies: 200 200 2717
...
--
-- TOC entry 2561 (class 2606 OID 16464)
-- Dependencies: 169 169 2717
...
--
-- TOC entry 2563 (class 2606 OID 16528)
-- Dependencies: 171 171 2717
...
--
-- TOC entry 2651 (class 2606 OID 27213)
-- Dependencies: 229 229 2717
...
--
-- TOC entry 2649 (class 2606 OID 27189)
-- Dependencies: 227 227 2717
...
--
-- TOC entry 2573 (class 2606 OID 16756)
-- Dependencies: 180 180 2717
...
--
-- TOC entry 2567 (class 2606 OID 16609)
-- Dependencies: 175 175 2717
...
--
-- TOC entry 2565 (class 2606 OID 16596)
-- Dependencies: 173 173 2717
...
--
-- TOC entry 2607 (class 2606 OID 17624)
-- Dependencies: 200 200 2717
...
--
-- TOC entry 2621 (class 2606 OID 27514)
-- Dependencies: 207 207 2717
...
--
-- TOC entry 2625 (class 2606 OID 27525)
-- Dependencies: 209 209 209 2717
...
--
-- TOC entry 2655 (class 2606 OID 27532)
-- Dependencies: 233 233 233 2717
...
--
-- TOC entry 2629 (class 2606 OID 27548)
-- Dependencies: 211 211 211 2717
...
--
-- TOC entry 2639 (class 2606 OID 27570)
-- Dependencies: 217 217 217 2717
...
--
-- TOC entry 2635 (class 2606 OID 27563)
-- Dependencies: 215 215 215 2717
...
--
-- TOC entry 2613 (class 2606 OID 18076)
-- Dependencies: 202 202 202 2717
...
--
-- TOC entry 2645 (class 2606 OID 26454)
-- Dependencies: 221 221 221 2717
...
--
-- TOC entry 2617 (class 2606 OID 18120)
-- Dependencies: 204 204 204 2717
...
--
-- TOC entry 2615 (class 2606 OID 26886)
-- Dependencies: 203 203 203 2717
...
--
-- TOC entry 2577 (class 2606 OID 16987)
-- Dependencies: 184 184 2717
...
--
-- TOC entry 2599 (class 2606 OID 17295)
-- Dependencies: 195 195 2717
...
--
-- TOC entry 2609 (class 2606 OID 17730)
-- Dependencies: 201 201 2717
...
--
-- TOC entry 2601 (class 2606 OID 17362)
-- Dependencies: 196 196 2717
...
--
-- TOC entry 2641 (class 2606 OID 26392)
-- Dependencies: 220 220 2717
...
--
-- TOC entry 2583 (class 2606 OID 17061)
-- Dependencies: 185 185 2717
...
--
-- TOC entry 2603 (class 2606 OID 17399)
-- Dependencies: 198 198 2717
...
--
-- TOC entry 2589 (class 2606 OID 17156)
-- Dependencies: 189 189 2717
...
--
-- TOC entry 2593 (class 2606 OID 17182)
-- Dependencies: 191 191 2717
...
--
-- TOC entry 2597 (class 2606 OID 17266)
-- Dependencies: 193 193 2717
...
--
-- TOC entry 2631 (class 2606 OID 26212)
-- Dependencies: 213 213 2717
...
--
-- TOC entry 2587 (class 2606 OID 17119)
-- Dependencies: 187 187 2717
...
--
-- TOC entry 2595 (class 2606 OID 17988)
-- Dependencies: 191 191 191 2717
...
--
-- TOC entry 2579 (class 2606 OID 26363)
-- Dependencies: 184 184 2717
...
--
-- TOC entry 2581 (class 2606 OID 17949)
-- Dependencies: 184 184 2717
...
--
-- TOC entry 2611 (class 2606 OID 18043)
-- Dependencies: 201 201 201 201 201 2717
...
--
-- TOC entry 2585 (class 2606 OID 17073)
-- Dependencies: 185 185 2717
...
--
-- TOC entry 2591 (class 2606 OID 17173)
-- Dependencies: 189 189 2717
...
--
-- TOC entry 2643 (class 2606 OID 26394)
-- Dependencies: 220 220 2717
...
--
-- TOC entry 2682 (class 2620 OID 27334)
-- Dependencies: 340 165 2717
...
--
-- TOC entry 2684 (class 2620 OID 27335)
-- Dependencies: 167 340 2717
...
--
-- TOC entry 2714 (class 2620 OID 27154)
-- Dependencies: 225 287 2717
...
--
-- TOC entry 2689 (class 2620 OID 26828)
-- Dependencies: 177 287 2717
...
--
-- TOC entry 2681 (class 2620 OID 26829)
-- Dependencies: 287 165 2717
...
--
-- TOC entry 2691 (class 2620 OID 26830)
-- Dependencies: 287 182 2717
...
--
-- TOC entry 2706 (class 2620 OID 26824)
-- Dependencies: 207 287 2717
...
--
-- TOC entry 2707 (class 2620 OID 26827)
-- Dependencies: 209 287 2717
...
--
-- TOC entry 2715 (class 2620 OID 27510)
-- Dependencies: 287 233 2717
...
--
-- TOC entry 2708 (class 2620 OID 26822)
-- Dependencies: 287 211 2717
...
--
-- TOC entry 2710 (class 2620 OID 26825)
-- Dependencies: 215 287 2717
...
--
-- TOC entry 2711 (class 2620 OID 26826)
-- Dependencies: 287 217 2717
...
--
-- TOC entry 2702 (class 2620 OID 26831)
-- Dependencies: 200 287 2717
...
--
-- TOC entry 2683 (class 2620 OID 26832)
-- Dependencies: 287 167 2717
...
--
-- TOC entry 2685 (class 2620 OID 26833)
-- Dependencies: 287 169 2717
...
--
-- TOC entry 2686 (class 2620 OID 26834)
-- Dependencies: 287 171 2717
...
--
-- TOC entry 2687 (class 2620 OID 26835)
-- Dependencies: 173 287 2717
...
--
-- TOC entry 2690 (class 2620 OID 26836)
-- Dependencies: 180 287 2717
...
--
-- TOC entry 2688 (class 2620 OID 26837)
-- Dependencies: 175 287 2717
...
--
-- TOC entry 2693 (class 2620 OID 27348)
-- Dependencies: 184 340 2717
-- Name: trigger_account_idaddress_to_zero; Type: TRIGGER; Schema: usaga; Owner: -
--

CREATE TRIGGER trigger_account_idaddress_to_zero AFTER UPDATE ON account FOR EACH ROW EXECUTE PROCEDURE public.trigger_idaddress_to_cero();


--
-- TOC entry 2692 (class 2620 OID 26838)
-- Dependencies: 287 184 2717
...
--
-- TOC entry 2703 (class 2620 OID 26839)
-- Dependencies: 287 202 2717
...
--
-- TOC entry 2694 (class 2620 OID 26840)
-- Dependencies: 287 185 2717
...
--
-- TOC entry 2696 (class 2620 OID 26841)
-- Dependencies: 189 287 2717
...
--
-- TOC entry 2697 (class 2620 OID 26842)
-- Dependencies: 287 191 2717
...
--
-- TOC entry 2698 (class 2620 OID 26843)
-- Dependencies: 287 193 2717
...
--
-- TOC entry 2713 (class 2620 OID 26844)
-- Dependencies: 287 221 2717
...
--
-- TOC entry 2705 (class 2620 OID 26845)
-- Dependencies: 204 287 2717
...
--
-- TOC entry 2704 (class 2620 OID 26846)
-- Dependencies: 287 203 2717
...
--
-- TOC entry 2699 (class 2620 OID 26847)
-- Dependencies: 287 195 2717
...
--
-- TOC entry 2700 (class 2620 OID 26848)
-- Dependencies: 287 196 2717
...
--
-- TOC entry 2712 (class 2620 OID 26849)
-- Dependencies: 220 287 2717
...
--
-- TOC entry 2701 (class 2620 OID 26850)
-- Dependencies: 198 287 2717
...
--
-- TOC entry 2709 (class 2620 OID 26851)
-- Dependencies: 287 213 2717
...
--
-- TOC entry 2695 (class 2620 OID 26852)
-- Dependencies: 287 187 2717
...
--
-- TOC entry 2656 (class 2606 OID 27343)
-- Dependencies: 167 2556 165 2717
...
--
-- TOC entry 2674 (class 2606 OID 27578)
-- Dependencies: 209 207 2618 2717
...
--
-- TOC entry 2680 (class 2606 OID 27585)
-- Dependencies: 233 209 2622 2717
...
--
-- TOC entry 2675 (class 2606 OID 27542)
-- Dependencies: 2652 211 233 2717
...
--
-- TOC entry 2676 (class 2606 OID 27592)
-- Dependencies: 2626 211 215 2717
...
--
-- TOC entry 2677 (class 2606 OID 27598)
-- Dependencies: 2632 217 215 2717
...
--
-- TOC entry 2659 (class 2606 OID 26709)
-- Dependencies: 177 167 2558 2717
...
--
-- TOC entry 2657 (class 2606 OID 26805)
-- Dependencies: 167 2558 175 2717
-- Name: fk_idphone; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2660 (class 2606 OID 26714)
-- Dependencies: 177 169 2560 2717
...
--
-- TOC entry 2658 (class 2606 OID 26810)
-- Dependencies: 2560 175 169 2717
-- Name: fk_idprovider; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2679 (class 2606 OID 27214)
-- Dependencies: 229 2562 171 2717
...
--
-- TOC entry 2678 (class 2606 OID 27190)
-- Dependencies: 2564 227 173 2717
...
--
-- TOC entry 2672 (class 2606 OID 26561)
-- Dependencies: 2576 184 204 2717
...
--
-- TOC entry 2673 (class 2606 OID 26566)
-- Dependencies: 2558 167 204 2717
...
--
-- TOC entry 2670 (class 2606 OID 26887)
-- Dependencies: 2576 203 184 2717
...
--
-- TOC entry 2671 (class 2606 OID 26892)
-- Dependencies: 203 165 2556 2717
...
--
-- TOC entry 2662 (class 2606 OID 26491)
-- Dependencies: 184 2576 185 2717
...
--
-- TOC entry 2664 (class 2606 OID 27280)
-- Dependencies: 184 189 2576 2717
-- Name: fk_idaccount; Type: FK CONSTRAINT; Schema: usaga; Owner: -
--
...
--
-- TOC entry 2668 (class 2606 OID 26921)
-- Dependencies: 202 2576 184 2717
...
--
-- TOC entry 2665 (class 2606 OID 26871)
-- Dependencies: 184 191 2576 2717
...
--
-- TOC entry 2669 (class 2606 OID 26926)
-- Dependencies: 2556 202 165 2717
...
--
-- TOC entry 2661 (class 2606 OID 27381)
-- Dependencies: 2640 184 220 2717
...
--
-- TOC entry 2667 (class 2606 OID 26540)
-- Dependencies: 193 2592 191 2717
...
--
-- TOC entry 2663 (class 2606 OID 26496)
-- Dependencies: 187 185 2586 2717
...
--
-- TOC entry 2666 (class 2606 OID 26876)
-- Dependencies: 167 191 2558 2717
...
-- Completed on 2013-02-25 08:39:15 ECT
