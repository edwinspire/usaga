...
-- Started on 2013-02-23 16:18:29 ECT
...
--
-- TOC entry 2695 (class 1262 OID 16384)
-- Dependencies: 2694
...
--
-- TOC entry 332 (class 1255 OID 27313)
-- Dependencies: 860 5
...
--
-- TOC entry 333 (class 1255 OID 27314)
-- Dependencies: 860 5
...
--
-- TOC entry 337 (class 1255 OID 27317)
-- Dependencies: 5 860
...
--
-- TOC entry 327 (class 1255 OID 27319)
-- Dependencies: 5 860
...
--
-- TOC entry 297 (class 1255 OID 26962)
-- Dependencies: 860 5
...
--
-- TOC entry 338 (class 1255 OID 27267)
-- Dependencies: 860 5
...
--
-- TOC entry 326 (class 1255 OID 27268)
-- Dependencies: 860 5
...
--
-- TOC entry 360 (class 1255 OID 27428)
-- Dependencies: 860 5
-- Name: fun_location_city_edit_xml(integer, integer, text, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_location_city_edit_xml(inidstate integer, inidcity integer, inname text, incode text, ints timestamp without time zone, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- TOC entry 255 (class 1255 OID 27424)
-- Dependencies: 5 860
-- Name: fun_location_city_remove_selected_xml(integer[], boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_location_city_remove_selected_xml(ids integer[], fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
outpgmsg TEXT DEFAULT 'Ninguna accion realizada';
outreturn INTEGER DEFAULT 0;
...
--
-- TOC entry 352 (class 1255 OID 27416)
-- Dependencies: 5 860
-- Name: fun_location_country_edit_xml(integer, text, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_location_country_edit_xml(inidcountry integer, inname text, incode text, ints timestamp without time zone, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- TOC entry 355 (class 1255 OID 27419)
-- Dependencies: 5 860
-- Name: fun_location_country_remove_selected_xml(integer[], boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_location_country_remove_selected_xml(ids integer[], fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
outpgmsg TEXT DEFAULT 'Ninguna accion realizada';
outreturn INTEGER DEFAULT 0;
...
--
-- TOC entry 357 (class 1255 OID 27429)
-- Dependencies: 5 860
-- Name: fun_location_sector_edit_xml(integer, integer, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_location_sector_edit_xml(inidcity integer, inidsector integer, inname text, ints timestamp without time zone, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- TOC entry 354 (class 1255 OID 27425)
-- Dependencies: 860 5
-- Name: fun_location_sector_remove_selected_xml(integer[], boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_location_sector_remove_selected_xml(ids integer[], fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
outpgmsg TEXT DEFAULT 'Ninguna accion realizada';
outreturn INTEGER DEFAULT 0;
...
--
-- TOC entry 256 (class 1255 OID 27427)
-- Dependencies: 5 860
-- Name: fun_location_state_edit_xml(integer, integer, text, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_location_state_edit_xml(inidcountry integer, inidstate integer, inname text, incode text, ints timestamp without time zone, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- TOC entry 359 (class 1255 OID 27431)
-- Dependencies: 860 5
-- Name: fun_location_state_remove_selected_xml(integer[], boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_location_state_remove_selected_xml(ids integer[], fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
outpgmsg TEXT DEFAULT 'Ninguna accion realizada';
outreturn INTEGER DEFAULT 0;
...
--
-- TOC entry 358 (class 1255 OID 27430)
-- Dependencies: 860 5
-- Name: fun_location_subsector_edit_xml(integer, integer, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_location_subsector_edit_xml(inidsector integer, inidsubsector integer, inname text, ints timestamp without time zone, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
--
-- TOC entry 356 (class 1255 OID 27426)
-- Dependencies: 5 860
-- Name: fun_location_subsector_remove_selected_xml(integer[], boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_location_subsector_remove_selected_xml(ids integer[], fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
outpgmsg TEXT DEFAULT 'Ninguna accion realizada';
outreturn INTEGER DEFAULT 0;
...
--
-- TOC entry 262 (class 1255 OID 17669)
-- Dependencies: 5 860
...
--
-- TOC entry 300 (class 1255 OID 26980)
-- Dependencies: 860 5
...
--
-- TOC entry 328 (class 1255 OID 27320)
-- Dependencies: 5 860
...
--
-- TOC entry 339 (class 1255 OID 27274)
-- Dependencies: 860 5
...
--
-- TOC entry 330 (class 1255 OID 27275)
-- Dependencies: 5 860
...
--
-- TOC entry 267 (class 1255 OID 17670)
-- Dependencies: 5 860
...
--
-- TOC entry 313 (class 1255 OID 27040)
-- Dependencies: 5 860
...
--
-- TOC entry 312 (class 1255 OID 27039)
-- Dependencies: 860 5
...
--
-- TOC entry 302 (class 1255 OID 26982)
-- Dependencies: 860 5
...
--
-- TOC entry 266 (class 1255 OID 17668)
-- Dependencies: 5 860
...
--
-- TOC entry 263 (class 1255 OID 17665)
-- Dependencies: 860 5
...
-- Dependencies: 2281 2282 2283 2284 2285 2286 2287 2288 2289 2290 2291 2292 2293 2294 2295 2296 2297 2298 2299 2300 2301 2302 2303 2304 2305 2306 2307 2308 1793 1793 5
...
--
-- TOC entry 275 (class 1255 OID 16715)
-- Dependencies: 860 5 719
...
--
-- TOC entry 265 (class 1255 OID 17664)
-- Dependencies: 860 5
...
-- Dependencies: 2321 2322 2323 2324 2325 5
...
--
-- TOC entry 264 (class 1255 OID 17663)
-- Dependencies: 734 860 5
...
--
-- TOC entry 353 (class 1255 OID 27420)
-- Dependencies: 860 5
-- Name: fun_state_remove_selected_xml(integer[], boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_state_remove_selected_xml(ids integer[], fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
outpgmsg TEXT DEFAULT 'Ninguna accion realizada';
outreturn INTEGER DEFAULT 0;
...
--
-- TOC entry 329 (class 1255 OID 27273)
-- Dependencies: 860 5
...
--
-- TOC entry 361 (class 1255 OID 27432)
-- Dependencies: 5 860
...
--
-- TOC entry 346 (class 1255 OID 27388)
-- Dependencies: 5 860
...
--
-- TOC entry 299 (class 1255 OID 26959)
-- Dependencies: 860 5
...
--
-- TOC entry 294 (class 1255 OID 26958)
-- Dependencies: 860 5
...
--
-- TOC entry 350 (class 1255 OID 27386)
-- Dependencies: 860 5
-- Name: fun_view_country_xml(boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION fun_view_country_xml(fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
OPEN CursorResult FOR SELECT idcountry, encode(name::bytea, 'base64') as name, encode(code::bytea, 'base64') as code, ts FROM location_country;
SELECT * FROM cursor_to_xml(CursorResult, 1000, false, false, '') INTO Retorno;
CLOSE CursorResult;

ELSE

OPEN CursorResult FOR SELECT * FROM location_country;
SELECT * FROM cursor_to_xml(CursorResult, 1000, false, false, '') INTO Retorno;
CLOSE CursorResult;
...
--
-- TOC entry 301 (class 1255 OID 26983)
-- Dependencies: 5 860
...
--
-- TOC entry 298 (class 1255 OID 26976)
-- Dependencies: 5 860
...
--
-- TOC entry 306 (class 1255 OID 27021)
-- Dependencies: 5 860
...
--
-- TOC entry 362 (class 1255 OID 27433)
-- Dependencies: 860 5
...
--
-- TOC entry 348 (class 1255 OID 27389)
-- Dependencies: 5 860
...
--
-- TOC entry 308 (class 1255 OID 27038)
-- Dependencies: 860 5
...
--
-- TOC entry 351 (class 1255 OID 27387)
-- Dependencies: 5 860
...
--
-- TOC entry 260 (class 1255 OID 27434)
-- Dependencies: 860 5
...
--
-- TOC entry 254 (class 1255 OID 27390)
-- Dependencies: 5 860
...
--
-- TOC entry 335 (class 1255 OID 27333)
-- Dependencies: 860 5
...
--
-- TOC entry 336 (class 1255 OID 27315)
-- Dependencies: 9 860
...
--
-- TOC entry 334 (class 1255 OID 27316)
-- Dependencies: 9 860
...
--
-- TOC entry 251 (class 1255 OID 27005)
-- Dependencies: 860 9
...
--
-- TOC entry 293 (class 1255 OID 26932)
-- Dependencies: 9 860
...
--
-- TOC entry 295 (class 1255 OID 26948)
-- Dependencies: 9 860
...
--
-- TOC entry 310 (class 1255 OID 26854)
-- Dependencies: 9 860
...
--
-- TOC entry 323 (class 1255 OID 27062)
-- Dependencies: 9 860
...
--
-- TOC entry 314 (class 1255 OID 27064)
-- Dependencies: 860 9
...
--
-- TOC entry 296 (class 1255 OID 26944)
-- Dependencies: 860 9
...
--
-- TOC entry 325 (class 1255 OID 27075)
-- Dependencies: 860 9
...
--
-- TOC entry 320 (class 1255 OID 27076)
-- Dependencies: 9 860
...
--
-- TOC entry 363 (class 1255 OID 27460)
-- Dependencies: 860 9
...
--
-- TOC entry 321 (class 1255 OID 27009)
-- Dependencies: 9 860
...
--
-- TOC entry 309 (class 1255 OID 27008)
-- Dependencies: 9 860
...
--
-- TOC entry 287 (class 1255 OID 27456)
-- Dependencies: 9 860
...
--
-- TOC entry 316 (class 1255 OID 27066)
-- Dependencies: 9 860
...
--
-- TOC entry 252 (class 1255 OID 17544)
-- Dependencies: 860 9
...
--
-- TOC entry 253 (class 1255 OID 27354)
-- Dependencies: 9 860
...
--
-- TOC entry 345 (class 1255 OID 27357)
-- Dependencies: 9 860
...
--
-- TOC entry 344 (class 1255 OID 27358)
-- Dependencies: 860 9
...
--
-- TOC entry 349 (class 1255 OID 27360)
-- Dependencies: 9 860
...
--
-- TOC entry 319 (class 1255 OID 27069)
-- Dependencies: 860 9
...
--
-- TOC entry 364 (class 1255 OID 27466)
-- Dependencies: 860 9
...
--
-- TOC entry 280 (class 1255 OID 26215)
-- Dependencies: 860 9
...
--
-- TOC entry 311 (class 1255 OID 27016)
-- Dependencies: 9 860
...
--
-- TOC entry 305 (class 1255 OID 27019)
-- Dependencies: 9 860
...
--
-- TOC entry 279 (class 1255 OID 25921)
-- Dependencies: 860 9
...
--
-- TOC entry 365 (class 1255 OID 27465)
-- Dependencies: 9 860
...
--
-- TOC entry 318 (class 1255 OID 27067)
-- Dependencies: 860 9
...
--
-- TOC entry 291 (class 1255 OID 26920)
-- Dependencies: 860 9
...
--
-- TOC entry 307 (class 1255 OID 26994)
-- Dependencies: 9 860
...
--
-- TOC entry 315 (class 1255 OID 27065)
-- Dependencies: 860 9
...
--
-- TOC entry 317 (class 1255 OID 27068)
-- Dependencies: 860 9
...
--
-- TOC entry 290 (class 1255 OID 27458)
-- Dependencies: 860 9
...
--
-- TOC entry 324 (class 1255 OID 27278)
-- Dependencies: 860 9
...
--
-- TOC entry 331 (class 1255 OID 27279)
-- Dependencies: 9 860
...
--
-- TOC entry 292 (class 1255 OID 27459)
-- Dependencies: 9 860
...
--
-- TOC entry 261 (class 1255 OID 27455)
-- Dependencies: 9 860
...
--
-- TOC entry 304 (class 1255 OID 26986)
-- Dependencies: 9 860
...
--
-- TOC entry 303 (class 1255 OID 26984)
-- Dependencies: 860 9
...
-- Dependencies: 2504 2505 2506 2507 2508 2509 2510 2511 1791 1791 1791 1791 5
...
-- Dependencies: 2314 2315 2316 1793 5
...
-- Dependencies: 2482 2483 2484 1793 5
...
-- Dependencies: 2232 2233 2234 2235 2236 2237 2238 2239 2240 2241 2242 2243 2244 2245 5
...
-- Dependencies: 2420 2421 2422 2423 2424 1793 5 1793 1793
...
-- Dependencies: 2247 2248 2249 2250 2251 2252 2253 2254 2255 2256 2257 5
...
-- Dependencies: 2259 2260 2261 2262 2263 5
...
-- Dependencies: 2265 2266 2267 2268 2269 2270 2271 2272 2273 2274 2275 2276 2277 2278 2279 1793 5 1793
...
-- Dependencies: 2525 2526 2527 2528 2529 2530 2531 2532 2533 2534 2535 5
...
-- Dependencies: 2513 2514 2515 2516 2517 2518 2519 2520 2521 2522 2523 5
...
-- Dependencies: 2227 1791 1793 1793 5
...
-- Dependencies: 2310 2311 2312 1793 5
...
-- Dependencies: 2339 2340 2341 2342 2343 2344 2345 2346 2347 1793 9
...
-- Dependencies: 2447 2448 2449 2450 2451 2452 2453 1791 9
...
-- Dependencies: 2348 2349 2350 2351 2352 2353 2354 2355 2356 9
...
-- Dependencies: 2364 2365 2366 2367 2368 2369 2370 1793 9
...
-- Dependencies: 2372 2373 2374 2375 2376 2377 2378 2379 1793 1793 9
...
-- Dependencies: 2466 2467 2468 2469 2470 2471 2472 9 1793
...
-- Dependencies: 2460 2461 2462 2463 2464 1793 1791 202 1793 9
...
-- Dependencies: 2384 2385 2386 2387 2388 2389 2390 2391 2393 2394 2395 2396 2397 2398 2399 2400 2401 2402 2403 2404 9 1793
...
-- Dependencies: 2405 2406 2407 2408 2409 2410 2411 2412 9
...
-- Dependencies: 2496 2497 2498 2499 1793 1793 9
...
-- Dependencies: 2414 2415 2416 2417 2418 1793 9
...
-- Dependencies: 2486 2487 2488 9 1791 1791
...
-- Dependencies: 2358 2359 2360 2361 2362 9
...
--
-- TOC entry 2503 (class 2604 OID 27139)
...
--
-- TOC entry 2313 (class 2604 OID 16625)
...
--
-- TOC entry 2231 (class 2604 OID 16390)
...
--
-- TOC entry 2326 (class 2604 OID 16836)
...
--
-- TOC entry 2481 (class 2604 OID 26180)
...
--
-- TOC entry 2473 (class 2604 OID 26137)
...
--
-- TOC entry 2489 (class 2604 OID 26240)
...
--
-- TOC entry 2477 (class 2604 OID 26159)
...
--
-- TOC entry 2492 (class 2604 OID 26260)
...
--
-- TOC entry 2419 (class 2604 OID 17585)
...
--
-- TOC entry 2246 (class 2604 OID 16426)
...
--
-- TOC entry 2258 (class 2604 OID 16455)
...
--
-- TOC entry 2264 (class 2604 OID 16525)
...
--
-- TOC entry 2524 (class 2604 OID 27200)
...
--
-- TOC entry 2280 (class 2604 OID 16582)
...
--
-- TOC entry 2512 (class 2604 OID 27176)
...
--
-- TOC entry 2320 (class 2604 OID 16748)
...
--
-- TOC entry 2309 (class 2604 OID 16602)
...
--
-- TOC entry 2338 (class 2604 OID 16979)
...
--
-- TOC entry 2371 (class 2604 OID 17179)
...
--
-- TOC entry 2380 (class 2604 OID 17264)
...
--
-- TOC entry 2454 (class 2604 OID 18090)
...
--
-- TOC entry 2455 (class 2604 OID 18091)
-- Dependencies: 203 203
...
--
-- TOC entry 2456 (class 2604 OID 18092)
-- Dependencies: 203 203
...
--
-- TOC entry 2457 (class 2604 OID 18093)
-- Dependencies: 203 203
...
--
-- TOC entry 2458 (class 2604 OID 18094)
-- Dependencies: 203 203
...
--
-- TOC entry 2459 (class 2604 OID 18095)
-- Dependencies: 203 203
...
--
-- TOC entry 2465 (class 2604 OID 26457)
-- Dependencies: 203 203
...
--
-- TOC entry 2392 (class 2604 OID 17292)
...
--
-- TOC entry 2436 (class 2604 OID 17717)
...
--
-- TOC entry 2437 (class 2604 OID 17718)
...
--
-- TOC entry 2438 (class 2604 OID 17719)
-- Dependencies: 201 201
-- Name: idaccount; Type: DEFAULT; Schema: usaga; Owner: -
--
...
--
-- TOC entry 2439 (class 2604 OID 17720)
-- Dependencies: 201 201
...
--
-- TOC entry 2440 (class 2604 OID 17721)
-- Dependencies: 201 201
...
--
-- TOC entry 2441 (class 2604 OID 17722)
-- Dependencies: 201 201
...
--
-- TOC entry 2442 (class 2604 OID 17723)
-- Dependencies: 201 201
...
--
-- TOC entry 2443 (class 2604 OID 17724)
-- Dependencies: 201 201
...
--
-- TOC entry 2445 (class 2604 OID 18022)
-- Dependencies: 201 201
...
--
-- TOC entry 2425 (class 2604 OID 25925)
-- Dependencies: 201 201
...
--
-- TOC entry 2426 (class 2604 OID 25942)
-- Dependencies: 201 201
...
--
-- TOC entry 2427 (class 2604 OID 25959)
-- Dependencies: 201 201
...
--
-- TOC entry 2428 (class 2604 OID 25976)
-- Dependencies: 201 201
...
--
-- TOC entry 2429 (class 2604 OID 25993)
-- Dependencies: 201 201
...
--
-- TOC entry 2430 (class 2604 OID 26010)
-- Dependencies: 201 201
-- Name: note; Type: DEFAULT; Schema: usaga; Owner: -
--
...
--
-- TOC entry 2431 (class 2604 OID 26033)
-- Dependencies: 201 201
...
--
-- TOC entry 2432 (class 2604 OID 26050)
-- Dependencies: 201 201
...
--
-- TOC entry 2433 (class 2604 OID 26067)
-- Dependencies: 201 201
...
--
-- TOC entry 2434 (class 2604 OID 26084)
-- Dependencies: 201 201
...
--
-- TOC entry 2435 (class 2604 OID 26101)
-- Dependencies: 201 201
...
--
-- TOC entry 2446 (class 2604 OID 26572)
-- Dependencies: 201 201
-- Name: ts; Type: DEFAULT; Schema: usaga; Owner: -
--
...
--
-- TOC entry 2495 (class 2604 OID 26384)
...
--
-- TOC entry 2413 (class 2604 OID 17392)
...
--
-- TOC entry 2485 (class 2604 OID 26205)
...
--
-- TOC entry 2357 (class 2604 OID 17111)
...
--
-- TOC entry 2363 (class 2604 OID 17146)
...
--
-- TOC entry 2539 (class 2606 OID 16428)
-- Dependencies: 167 167 2691
...
--
-- TOC entry 2607 (class 2606 OID 26187)
-- Dependencies: 211 211 2691
...
--
-- TOC entry 2627 (class 2606 OID 27152)
-- Dependencies: 225 225 2691
...
--
-- TOC entry 2549 (class 2606 OID 16632)
-- Dependencies: 177 177 2691
...
--
-- TOC entry 2599 (class 2606 OID 26142)
-- Dependencies: 207 207 2691
...
--
-- TOC entry 2551 (class 2606 OID 16704)
-- Dependencies: 178 178 2691
...
--
-- TOC entry 2555 (class 2606 OID 16845)
-- Dependencies: 182 182 2691
...
--
-- TOC entry 2585 (class 2606 OID 17587)
-- Dependencies: 200 200 2691
...
--
-- TOC entry 2541 (class 2606 OID 16464)
-- Dependencies: 169 169 2691
...
--
-- TOC entry 2613 (class 2606 OID 26247)
-- Dependencies: 215 215 2691
...
--
-- TOC entry 2543 (class 2606 OID 16528)
-- Dependencies: 171 171 2691
...
--
-- TOC entry 2631 (class 2606 OID 27213)
-- Dependencies: 229 229 2691
...
--
-- TOC entry 2629 (class 2606 OID 27189)
-- Dependencies: 227 227 2691
...
--
-- TOC entry 2553 (class 2606 OID 16756)
-- Dependencies: 180 180 2691
...
--
-- TOC entry 2603 (class 2606 OID 26167)
-- Dependencies: 209 209 2691
...
--
-- TOC entry 2617 (class 2606 OID 26267)
-- Dependencies: 217 217 2691
...
--
-- TOC entry 2547 (class 2606 OID 16609)
-- Dependencies: 175 175 2691
...
--
-- TOC entry 2545 (class 2606 OID 16596)
-- Dependencies: 173 173 2691
...
--
-- TOC entry 2615 (class 2606 OID 26249)
-- Dependencies: 215 215 215 2691
...
--
-- TOC entry 2619 (class 2606 OID 26269)
-- Dependencies: 217 217 217 2691
...
--
-- TOC entry 2609 (class 2606 OID 26229)
-- Dependencies: 211 211 211 2691
...
--
-- TOC entry 2605 (class 2606 OID 26222)
-- Dependencies: 209 209 209 2691
...
--
-- TOC entry 2587 (class 2606 OID 17624)
-- Dependencies: 200 200 2691
...
--
-- TOC entry 2601 (class 2606 OID 26153)
-- Dependencies: 207 207 2691
...
--
-- TOC entry 2593 (class 2606 OID 18076)
-- Dependencies: 202 202 202 2691
...
--
-- TOC entry 2625 (class 2606 OID 26454)
-- Dependencies: 221 221 221 2691
...
--
-- TOC entry 2597 (class 2606 OID 18120)
-- Dependencies: 204 204 204 2691
...
--
-- TOC entry 2595 (class 2606 OID 26886)
-- Dependencies: 203 203 203 2691
...
--
-- TOC entry 2557 (class 2606 OID 16987)
-- Dependencies: 184 184 2691
...
--
-- TOC entry 2579 (class 2606 OID 17295)
-- Dependencies: 195 195 2691
...
--
-- TOC entry 2589 (class 2606 OID 17730)
-- Dependencies: 201 201 2691
...
--
-- TOC entry 2581 (class 2606 OID 17362)
-- Dependencies: 196 196 2691
...
--
-- TOC entry 2621 (class 2606 OID 26392)
-- Dependencies: 220 220 2691
...
--
-- TOC entry 2563 (class 2606 OID 17061)
-- Dependencies: 185 185 2691
...
--
-- TOC entry 2583 (class 2606 OID 17399)
-- Dependencies: 198 198 2691
...
--
-- TOC entry 2569 (class 2606 OID 17156)
-- Dependencies: 189 189 2691
...
--
-- TOC entry 2573 (class 2606 OID 17182)
-- Dependencies: 191 191 2691
...
--
-- TOC entry 2577 (class 2606 OID 17266)
-- Dependencies: 193 193 2691
...
--
-- TOC entry 2611 (class 2606 OID 26212)
-- Dependencies: 213 213 2691
...
--
-- TOC entry 2567 (class 2606 OID 17119)
-- Dependencies: 187 187 2691
...
--
-- TOC entry 2575 (class 2606 OID 17988)
-- Dependencies: 191 191 191 2691
...
--
-- TOC entry 2559 (class 2606 OID 26363)
-- Dependencies: 184 184 2691
...
--
-- TOC entry 2561 (class 2606 OID 17949)
-- Dependencies: 184 184 2691
...
--
-- TOC entry 2591 (class 2606 OID 18043)
-- Dependencies: 201 201 201 201 201 2691
...
--
-- TOC entry 2565 (class 2606 OID 17073)
-- Dependencies: 185 185 2691
...
--
-- TOC entry 2571 (class 2606 OID 17173)
-- Dependencies: 189 189 2691
...
--
-- TOC entry 2623 (class 2606 OID 26394)
-- Dependencies: 220 220 2691
...
--
-- TOC entry 2657 (class 2620 OID 27334)
-- Dependencies: 165 335 2691
...
--
-- TOC entry 2659 (class 2620 OID 27335)
-- Dependencies: 167 335 2691
...
--
-- TOC entry 2689 (class 2620 OID 27154)
-- Dependencies: 225 286 2691
...
--
-- TOC entry 2683 (class 2620 OID 26822)
-- Dependencies: 286 211 2691
...
--
-- TOC entry 2681 (class 2620 OID 26824)
-- Dependencies: 286 207 2691
...
--
-- TOC entry 2685 (class 2620 OID 26825)
-- Dependencies: 286 215 2691
...
--
-- TOC entry 2682 (class 2620 OID 26827)
-- Dependencies: 209 286 2691
...
--
-- TOC entry 2686 (class 2620 OID 26826)
-- Dependencies: 217 286 2691
...
--
-- TOC entry 2664 (class 2620 OID 26828)
-- Dependencies: 286 177 2691
...
--
-- TOC entry 2656 (class 2620 OID 26829)
-- Dependencies: 286 165 2691
...
--
-- TOC entry 2666 (class 2620 OID 26830)
-- Dependencies: 286 182 2691
...
--
-- TOC entry 2677 (class 2620 OID 26831)
-- Dependencies: 200 286 2691
...
--
-- TOC entry 2658 (class 2620 OID 26832)
-- Dependencies: 286 167 2691
...
--
-- TOC entry 2660 (class 2620 OID 26833)
-- Dependencies: 286 169 2691
...
--
-- TOC entry 2661 (class 2620 OID 26834)
-- Dependencies: 171 286 2691
...
--
-- TOC entry 2662 (class 2620 OID 26835)
-- Dependencies: 286 173 2691
...
--
-- TOC entry 2665 (class 2620 OID 26836)
-- Dependencies: 180 286 2691
...
--
-- TOC entry 2663 (class 2620 OID 26837)
-- Dependencies: 175 286 2691
...
--
-- TOC entry 2668 (class 2620 OID 27348)
-- Dependencies: 184 335 2691
...
--
-- TOC entry 2667 (class 2620 OID 26838)
-- Dependencies: 286 184 2691
...
--
-- TOC entry 2678 (class 2620 OID 26839)
-- Dependencies: 286 202 2691
...
--
-- TOC entry 2669 (class 2620 OID 26840)
-- Dependencies: 185 286 2691
...
--
-- TOC entry 2671 (class 2620 OID 26841)
-- Dependencies: 189 286 2691
...
--
-- TOC entry 2672 (class 2620 OID 26842)
-- Dependencies: 191 286 2691
...
--
-- TOC entry 2673 (class 2620 OID 26843)
-- Dependencies: 193 286 2691
...
--
-- TOC entry 2688 (class 2620 OID 26844)
-- Dependencies: 221 286 2691
...
--
-- TOC entry 2680 (class 2620 OID 26845)
-- Dependencies: 286 204 2691
...
--
-- TOC entry 2679 (class 2620 OID 26846)
-- Dependencies: 286 203 2691
...
--
-- TOC entry 2674 (class 2620 OID 26847)
-- Dependencies: 195 286 2691
...
--
-- TOC entry 2675 (class 2620 OID 26848)
-- Dependencies: 196 286 2691
...
--
-- TOC entry 2687 (class 2620 OID 26849)
-- Dependencies: 220 286 2691
...
--
-- TOC entry 2676 (class 2620 OID 26850)
-- Dependencies: 286 198 2691
...
--
-- TOC entry 2684 (class 2620 OID 26851)
-- Dependencies: 286 213 2691
...
--
-- TOC entry 2670 (class 2620 OID 26852)
-- Dependencies: 286 187 2691
...
--
-- TOC entry 2652 (class 2606 OID 27445)
-- Dependencies: 211 2606 215 2691
...
--
-- TOC entry 2632 (class 2606 OID 27343)
-- Dependencies: 165 2536 167 2691
...
--
-- TOC entry 2650 (class 2606 OID 27440)
-- Dependencies: 2598 207 209 2691
-- Name: fk_idcountry_state; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY location_states
    ADD CONSTRAINT fk_idcountry_state FOREIGN KEY (idcountry) REFERENCES location_country(idcountry) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 2635 (class 2606 OID 26709)
-- Dependencies: 2538 177 167 2691
...
--
-- TOC entry 2633 (class 2606 OID 26805)
-- Dependencies: 2538 175 167 2691
-- Name: fk_idphone; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2636 (class 2606 OID 26714)
-- Dependencies: 177 2540 169 2691
...
--
-- TOC entry 2634 (class 2606 OID 26810)
-- Dependencies: 169 175 2540 2691
-- Name: fk_idprovider; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2655 (class 2606 OID 27214)
-- Dependencies: 229 171 2542 2691
...
--
-- TOC entry 2654 (class 2606 OID 27190)
-- Dependencies: 2544 173 227 2691
...
--
-- TOC entry 2651 (class 2606 OID 27450)
-- Dependencies: 211 209 2602 2691
...
--
-- TOC entry 2653 (class 2606 OID 27435)
-- Dependencies: 2612 217 215 2691
-- Name: fk_idsubsector_sector; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY location_subsector
    ADD CONSTRAINT fk_idsubsector_sector FOREIGN KEY (idsector) REFERENCES location_sector(idsector) ON UPDATE CASCADE ON DELETE CASCADE;


SET search_path = usaga, pg_catalog;

--
-- TOC entry 2648 (class 2606 OID 26561)
-- Dependencies: 2556 184 204 2691
...
--
-- TOC entry 2649 (class 2606 OID 26566)
-- Dependencies: 167 2538 204 2691
...
--
-- TOC entry 2646 (class 2606 OID 26887)
-- Dependencies: 184 203 2556 2691
...
--
-- TOC entry 2647 (class 2606 OID 26892)
-- Dependencies: 2536 165 203 2691
...
--
-- TOC entry 2638 (class 2606 OID 26491)
-- Dependencies: 184 2556 185 2691
...
--
-- TOC entry 2640 (class 2606 OID 27280)
-- Dependencies: 2556 189 184 2691
-- Name: fk_idaccount; Type: FK CONSTRAINT; Schema: usaga; Owner: -
--
...
--
-- TOC entry 2644 (class 2606 OID 26921)
-- Dependencies: 2556 184 202 2691
...
--
-- TOC entry 2641 (class 2606 OID 26871)
-- Dependencies: 184 191 2556 2691
...
--
-- TOC entry 2645 (class 2606 OID 26926)
-- Dependencies: 202 2536 165 2691
...
--
-- TOC entry 2637 (class 2606 OID 27381)
-- Dependencies: 2620 184 220 2691
...
--
-- TOC entry 2643 (class 2606 OID 26540)
-- Dependencies: 191 193 2572 2691
...
--
-- TOC entry 2639 (class 2606 OID 26496)
-- Dependencies: 185 187 2566 2691
...
--
-- TOC entry 2642 (class 2606 OID 26876)
-- Dependencies: 167 191 2538 2691
...
-- Completed on 2013-02-23 16:18:33 ECT
