...
-- Started on 2013-02-03 16:42:38 ECT
...
--
-- TOC entry 322 (class 1255 OID 27274)
-- Dependencies: 826 5
...
-- Dependencies: 2247 2248 2249 2250 2251 2252 2253 2254 2255 2256 2257 2258 2259 2260 2261 2262 2263 2264 2265 2266 2267 2268 2269 2270 2271 2272 2273 2274 5 1759 1759
...
--
-- TOC entry 321 (class 1255 OID 27273)
-- Dependencies: 826 5
...
--
-- TOC entry 327 (class 1255 OID 27271)
-- Dependencies: 5 826
-- Name: xxxfun_address_edit(integer, text, real, real, text, text, text, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxfun_address_edit(inidaddress integer, inidlocation text, ingeox real, ingeoy real, inmstreet text, insstreet text, inother text, innote text, ints timestamp without time zone, fieldtextasbase64 boolean, OUT outreturn integer, OUT outpgmsg text) RETURNS record
    LANGUAGE plpgsql
    AS $$BEGIN
...
--
-- TOC entry 325 (class 1255 OID 27272)
-- Dependencies: 5 826
-- Name: xxxfun_address_edit_xml(integer, text, real, real, text, text, text, text, timestamp without time zone, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION xxxfun_address_edit_xml(inidaddress integer, inidlocation text, ingeox real, ingeoy real, inmstreet text, insstreet text, inother text, innote text, ints timestamp without time zone, fieldtextasbase64 boolean) RETURNS text
    LANGUAGE plpgsql
    AS $$DECLARE
...
-- Dependencies: 2475 2476 2477 2478 2479 2480 2481 2482 1757 5 1757 1757 1757
...
-- Dependencies: 2459 2460 2461 5 1757
...
-- Dependencies: 2463 2464 2465 5 1759
...
-- Dependencies: 2280 2281 2282 1759 5
...
-- Dependencies: 2450 2451 2452 2453 5 1759
...
-- Dependencies: 2198 2199 2200 2201 2202 2203 2204 2205 2206 2207 2208 2209 2210 2211 5
...
-- Dependencies: 2293 2294 2295 2296 2297 2298 2299 2300 2301 2302 2303 5
...
-- Dependencies: 2387 2388 2389 2390 2391 5 1759 1759 1759
...
-- Dependencies: 2213 2214 2215 2216 2217 2218 2219 2220 2221 2222 2223 5
...
-- Dependencies: 2225 2226 2227 2228 2229 5
...
-- Dependencies: 2231 2232 2233 2234 2235 2236 2237 2238 2239 2240 2241 2242 2243 2244 2245 1759 5 1759
...
-- Dependencies: 2193 5 1759 1757 1759
...
-- Dependencies: 2276 2277 2278 5 1759
...
-- Dependencies: 2305 2306 2307 2308 2309 2310 2311 2312 2313 2314 1759 9
...
-- Dependencies: 2414 2415 2416 2417 2418 2419 2420 9 1757
...
-- Dependencies: 2331 2332 2333 2334 2335 2336 2337 1759 9
...
-- Dependencies: 2339 2340 2341 2342 2343 2344 2345 2346 1759 1759 9
...
-- Dependencies: 2433 2434 2435 2436 2437 2438 2439 9 1759
...
-- Dependencies: 2427 2428 2429 2430 2431 1757 1759 202 9 1759
...
-- Dependencies: 2351 2352 2353 2354 2355 2356 2357 2358 2360 2361 2362 2363 2364 2365 2366 2367 2368 2369 2370 2371 1759 9
...
-- Dependencies: 2467 2468 2469 2470 9 1759 1759
...
-- Dependencies: 2381 2382 2383 2384 2385 9 1759
...
-- Dependencies: 2455 2456 2457 1757 1757 9
...
--
-- TOC entry 2279 (class 2604 OID 16625)
...
--
-- TOC entry 2197 (class 2604 OID 16390)
...
--
-- TOC entry 2292 (class 2604 OID 16836)
...
--
-- TOC entry 2212 (class 2604 OID 16426)
...
--
-- TOC entry 2224 (class 2604 OID 16455)
...
--
-- TOC entry 2230 (class 2604 OID 16525)
...
--
-- TOC entry 2246 (class 2604 OID 16582)
...
--
-- TOC entry 2286 (class 2604 OID 16748)
...
--
-- TOC entry 2275 (class 2604 OID 16602)
...
--
-- TOC entry 2304 (class 2604 OID 16979)
...
-- Dependencies: 215 211 2577 2658
...
-- Dependencies: 165 167 2507 2658
...
-- Dependencies: 209 207 2569 2658
...
-- Dependencies: 167 177 2509 2658
...
-- Dependencies: 167 2509 175 2658
-- Name: fk_idphone; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Dependencies: 2511 169 177 2658
...
-- Dependencies: 175 2511 169 2658
-- Name: fk_idprovider; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Dependencies: 217 215 2583 2658
...
-- Dependencies: 2513 171 229 2658
...
-- Dependencies: 227 2515 173 2658
...
-- Dependencies: 204 2527 184 2658
...
-- Dependencies: 167 2509 204 2658
...
-- Dependencies: 203 2527 184 2658
...
-- Dependencies: 185 184 2527 2658
...
--
-- TOC entry 2610 (class 2606 OID 27280)
...
-- Dependencies: 202 184 2527 2658
...
-- Dependencies: 2527 184 191 2658
...
-- Dependencies: 202 2507 165 2658
...
-- Dependencies: 193 191 2543 2658
...
-- Dependencies: 185 2537 187 2658
...
-- Completed on 2013-02-03 16:42:39 ECT
