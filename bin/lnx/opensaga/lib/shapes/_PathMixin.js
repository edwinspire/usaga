...
var _11=dojo.style(this.domNode,"stroke");
var _12=dojo.style(this.domNode,"stroke-width");
var _13=this._checkForwardBackward(this.startarrow)?this._computeArrowHead(this._points,{type:"start",arrowDir:this.startarrow,width:8,height:13,fill:_11,stroke:_11,strokeWidth:_12}):"";
var _14=this._checkForwardBackward(this.endarrow)?this._computeArrowHead(this._points,{type:"end",arrowDir:this.endarrow,width:8,height:13,fill:_11,stroke:_11,strokeWidth:_12}):"";
this.domNode.innerHTML=this._header+_10+_13+_14+this._footer;
