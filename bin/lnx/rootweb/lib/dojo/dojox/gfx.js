...
//>>built
require({cache:{"dojox/gfx/_base":function(){
...
define(["./_base","dojo/_base/lang","dojo/_base/sniff","dojo/_base/window","dojo/_base/config"],function(g,_2b,has,win,_2c){
var _2d=null;
return {load:function(id,_2e,_2f){
if(_2d&&id!="force"){
_2f(_2d);
return;
}
var _30=_2c.forceGfxRenderer,_31=!_30&&(_2b.isString(_2c.gfxRenderer)?_2c.gfxRenderer:"svg,vml,canvas,silverlight").split(","),_32,_33;
while(!_30&&_31.length){
switch(_31.shift()){
case "svg":
...
try{
if(has("ie")){
_32=new ActiveXObject("AgControl.AgControl");
if(_32&&_32.IsVersionSupported("1.0")){
_33=true;
}
}else{
...
if(_30==="canvas"&&_2c.canvasEvents!==false){
_30="canvasWithEvents";
}
if(_2c.isDebug){
}
function _34(){
_2e(["dojox/gfx/"+_30],function(_35){
g.renderer=_30;
_2d=_35;
_2f(_35);
});
};
if(_30=="svg"&&typeof window.svgweb!="undefined"){
window.svgweb.addOnLoad(_34);
}else{
_34();
}
}};
...
define("dojox/gfx",["dojo/_base/lang","./gfx/_base","./gfx/renderer!"],function(_36,_37,_38){
_37.switchTo(_38);
return _37;
});
